...
/* DO DRILL ***************************************************/
 ...
 /**
  ...
  Mapper_prototype.parseSimple = function(strCdfId,objSchemaNode,bAttribute,bRedraw) {
    ...
    //3.5.1 HF01: fixed the 3.5 regression(was writing, not reading, resulting in all new restrictions being immediately deleted
 ...
 /**
  ...
  Mapper_prototype.setFormDefaults = function(objRNode,objSNode) {
    ...
    var strEFD, strAFD;
    //3.5.1 HF01:  check the local form--it takes precedence over the form-default declared by the schema
