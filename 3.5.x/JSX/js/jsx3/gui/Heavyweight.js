...
jsx3.Class.defineClass("jsx3.gui.Heavyweight", null, null, function(Heavyweight, Heavyweight_prototype) {
  ...
  Heavyweight_prototype.show = function(bDisplay) {
    ...
    var strHTML = '<span id="' + strId + '" class="jsx30block" style="position:absolute;overflow:;' +
        strWidth + strHeight + 'left:0px;top:0px;z-index:' + this.getZIndex() + ';visibility:hidden;">' + strText + '</span>';
...
//    jsx3.log("_showHideVerticalScrollers intH:" + intH + " intContentH:" + intContentH + " intTop:" + intTop);
  ...
  /** @private @jsxobf-clobber */
  Heavyweight_prototype._scrollOver = function(objEvent, objGUI, bUp) {
  ...
  /** @private @jsxobf-clobber */
  Heavyweight_prototype._scroll = function(bUp) {
    ...
    if (objHwGUI) {
      ...
      var newTop = Math.min(0, Math.max(intTop + (bUp ? 1 : -1) * Heavyweight._SCROLL_AMOUNT, intH - intContentH));
...
//    jsx3.log("onContentScroll new-top: " + newTop + " top:" + intTop + " offset:" + intOffset + " height:" + intH);
   ...
   */
  Heavyweight_prototype.applyRatio = function() {
