...
jsx3.Class.defineClass("jsx3.io.File", null, null, function(File, File_prototype) {
   ...
   */
  File_prototype.read = function(bUnicode) {
    try {
      var forReading = 1;
      ...
      var f = oFile.OpenAsTextStream(forReading, bUnicode ? -1 : -2);
...
//    return ext;
   ...
   *
  File.getTempFile = function() {
    var tfolder = File.FSO.GetSpecialFolder(2);
    var tname = File.FSO.GetTempName();
    return new File(tfolder + "\\" + tname);
  };/
