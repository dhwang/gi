...
jsx3.Class.defineClass("jsx3.app.Properties", null, null, function(Properties, Properties_prototype) {
  ...
  /** @private @jsxobf-clobber */
  Properties_prototype._isParentsDirty = function() {
    for (var i = 0; i < this._parents.length && !this._parentsDirty; i++) {
      var p = this._parents[i];
      this._parentsDirty = p._masterDirty || p._isParentsDirty();
    }
    return this._parentsDirty;
  };
  ...
  /** @private @jsxobf-clobber */
  Properties_prototype._setChildrenDirty = function() {
    for (var i = 0; i < this._children.length; i++)
      this._children[i]._parentsDirty = true;
  };
