...
/* CONSTANTS ************************************************************/
  ...
  Service.ns = {};
  Service.ns["SOAP-ENV"] = "http://schemas.xmlsoap.org/soap/envelope/";
  Service.ns["SOAP-ENC"] = "http://schemas.xmlsoap.org/soap/encoding/";
  Service.ns["xsi"]      = "http://www.w3.org/2001/XMLSchema-instance";
  Service.ns["xsd"]      = "http://www.w3.org/2001/XMLSchema";
  ...
  Service_prototype.init = function(strRulesURL,strOperationName,strOutboundURL,strInboundURL) {
    ...
    var objRequest = new jsx3.net.Request(this.getUniqueId());
...
/* @JSC :: end */
   ...
   * @return   {String} one of: GET or POST
   */
   ...
   * @param METHOD   {String} one of: GET or POST
   */
  ...
  Service_prototype.doCall = function(bCancelIfInvalid) {
    ...
    if (objRulesXML != null) {
      ...
      if (!this.getMode()) {
        ...
        //var objStaticResponse = new jsx3.xml.Document();
        //objStaticResponse.load(strStaticResponseUrl);
        if (objStaticResponse.hasError()) {
          ...
          jsx3.sleep(function() { this.onResponse({target:{getResponseXML:function() { return objStaticResponse; }}}); }, null, this);
        }
      } else {
        ...
        if (strStaticRequestUrl) {
          ...
          //objMessage = new jsx3.xml.Document();
          //objMessage.load(strStaticRequestUrl);
        ...
        if (!this._isValid() && bCancelIfInvalid) {
          ...
          //TO DO: how to ensure serialized as UTF-8?
          var strXML = (objMessage != null && objMessage instanceof jsx3.xml.Document && !objMessage.hasError()) ? objMessage.serialize("1.0") : null;
          objRequest.send(strXML,this.getTimeout());
          return true;
        }
      }
    }
...
/* @JSC :: end */
  ...
  Service_prototype.getServiceMessage = function(MESSAGETYPE,strShellURL)  {
    ...
    if (strShellURL || objEnvelope instanceof jsx3.xml.Document) {
      ...
      if (!(objEnvelope instanceof jsx3.xml.Document)) {
        ...
        //objEnvelope = new jsx3.xml.Document();
        //objEnvelope.load(strShellURL);
      }
  ...
  Service_prototype.registerNamespace = function(strURI,objMessage,bFirst) {
    ...
    if (strURI != "" && this.nshash[strURI] != null) {
  ...
  Service_prototype.doAddAndRecurse = function(_jsx_objMessage,_jsx_objMessageParent,RULENODE,MESSAGETYPE,bFirst) {
    ...
    var objNS = (strMyURI) ? this.registerNamespace(strMyURI,_jsx_objMessage,bFirst) : {prefix:"",uri:""};
    ...
    if (RULENODE.getAttribute("type") == "A") {
      //attribute node
      var bATT = true;
      var MESSAGENODE = _jsx_objMessage.createNode(jsx3.Entity.TYPEATTRIBUTE,objNS.prefix + ((objNS.prefix != "") ? ":" : "") + strText,objNS.uri);
      ...
      if (_jsx_objMessage) {
        var MESSAGENODE = _jsx_objMessage.createNode(jsx3.Entity.TYPEELEMENT,objNS.prefix + ((objNS.prefix != "") ? ":" : "") + strText,objNS.uri);
        _jsx_objMessageParent.appendChild(MESSAGENODE);
      } else {
      ...
      var myEncodedNode = RULENODE.selectSingleNode("ancestor-or-self::record[(@type='I' or @type='O') and @soapuse='encoded' and @soapencstyle='" + Service.ns["SOAP-ENC"] + "']")
      if (myEncodedNode != null && myEncodedNode != "") {
        ...
        if ((attValue = RULENODE.getAttribute("datatype")) != null && attValue != "") {
          ...
          var _typeatt = _jsx_objMessage.createNode(jsx3.Entity.TYPEATTRIBUTE,"xsi:type","http://www.w3.org/2001/XMLSchema-instance");
    ...
    for (var i = objMappings.iterator(); i.hasNext(); ) {
      ...
      if (OBJECTTYPE == "DOM") {
        ...
        if (objRecord = this.CDFCONTEXT.records.next()) {
          ...
          var _otempcontext = objRecord;
          var _otemprecords = objRecord.selectNodes("record");
    ...
    } else if (MESSAGENODE.getValue() == "" && RULENODE.selectSingleNode("record") == null && RULENODE.getAttribute("type") != "A" && !bFirst && RULENODE.selectSingleNode("restrictions/record[@name='nillable' and @value='true']") == null) {
    ...
    if (!bCancel && RULENODE.getAttribute("groupref") != "1" && RULENODE.getParent().getAttribute("groupref") == "1") {
      ...
      var objMsgParent = MESSAGENODE.getParent();
  ...
  Service_prototype.validate = function(objMsg,objRule) {
    ...
    if (objRestrictions.size() > 0) {
      ...
      if (objRule.selectSingleNode("restrictions/record[@name='enumeration' and @value='" + strMyValue + "']") != null) return true;

      for (var i=objRestrictions.iterator(); i.hasNext(); ) {
  ...
  Service_prototype.doMapAndUpdate = function(objMapNode,objJSX,DATAFLOW,objRuleNode) {
    ...
    if (objJSX.isInstanceOf("jsx3.gui.Form")) {
      //radio buttons and checkboxes  get special handling
      if (objJSX.isInstanceOf("jsx3.gui.RadioButton")) {
        if (DATAFLOW == "INBOUND") {
      ...
      } else if (objJSX.isInstanceOf("jsx3.gui.CheckBox")) {
        if (DATAFLOW == "INBOUND") {
    ...
    } else if (objJSX.isInstanceOf("jsx3.gui.Block")) {
      if (DATAFLOW == "INBOUND") {
  ...
  Service_prototype.doReadAndRecurse = function(MESSAGENODE,RULENODE) {
    ...
    //recurse to read rules from descendant structures
    if (RECURSE) {
      //get all children that either define a rule or contain another child that might define a rule
      var objRuleChildren = RULENODE.selectNodes("*[name()='record' and (record or mappings)]");
   ...
   * @param objEvent {Object} Event object with named properties. 'target' is the Request instance
   * @private
   */
  Service_prototype.onResponse = function(objEvent) {
    ...
    if (objRequest instanceof jsx3.net.Request) {
      ...
      var objXML = objRequest.getResponseXML();
      ...
      //get the response document
      this.setInboundDocument(objRequest.getResponseXML());
      this.status = 200;
...
//   ------------------------ XSLT COMPILER ----------------------------------
  ...
  Service_prototype.compile = function() {
    ...
    //create an array that will contain the XSLT as it is created. Since XSLT is more functional that procedural, the array will flatten the
    //nested structures into a collection of callable templates
    var objStylesheet = [];
  ...
  Service_prototype._registerCompilerNamespace = function(objRuleNode) {
    ...
    if (strTNS && (strTNS = jsx3.util.strTrim(String(strTNS))) != "") {
