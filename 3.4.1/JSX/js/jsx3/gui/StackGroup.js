...
/* @JSC :: end */
   ...
   * @private
   */
  StackGroup_prototype.getClientDimensions = function(objChild) {
  ...
  StackGroup_prototype.updateBoxProfile = function(objImplicit, objGUI, objQueue) {
    ...
    for (var i = 0; i < maxLen; i++) {
      ...
      var objImplicitChild = this.getClientDimensions(objChild);
...
//    this.setOverflow(jsx3.gui.Block.OVERFLOWSCROLL);
  ...
  StackGroup_prototype.paintChild = function(objJSX, bLoop) {
    ...
    if (!bLoop) this._updateDimensionArray();
  };
   ...
   * @jsxobf-clobber
   */
  StackGroup_prototype._updateDimensionArray = function() {
    var a = [];
