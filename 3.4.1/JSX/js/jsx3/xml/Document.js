...
/* @JSC */ if (jsx3.CLASS_LOADER.IE) {
  ...
  Document_prototype._loadCatch = function(objURL, intTimeout, bAsync) {
    ...
    try {
      if (bAsync)
        this._document.onreadystatechange = jsx3.makeCallback(function() { this._onAsyncReadyStateChange(); }, this);
...
/* @JSC */ } else if (jsx3.CLASS_LOADER.SAF) {
  ...
  Document_prototype._loadCatch = function(objURL, intTimeout, bAsync) {
    ...
    try {
      ...
      if (bAsync)
        req.onload = jsx3.makeCallback(function() { this._onAsyncLoad(req); }, this);
...
/* @JSC */ } else if (jsx3.CLASS_LOADER.FX) {
  ...
  Document_prototype._loadCatch = function(objURL, intTimeout, bAsync) {
    ...
    try {
      ...
      if (bAsync) {
        this._jsxloadlistener = jsx3.makeCallback(function() { this._onAsyncLoad(); }, this);
...
/* @JSC */ if (jsx3.CLASS_LOADER.IE) {
  ...
  Document_prototype._onAsyncReadyStateChange = function() {
    var state = this._document.readyState;
    if (state == 4) {
      this._asyncCleanup();
