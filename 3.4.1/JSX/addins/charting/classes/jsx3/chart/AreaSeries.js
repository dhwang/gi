...
jsx3.Class.defineClass("jsx3.chart.AreaSeries", jsx3.chart.Series, null, function(AreaSeries, AreaSeries_prototype) {
   ...
   * @jsxobf-clobber
   */
  AreaSeries.FORMS = {segment: 1, step: 1, reverseStep: 1};
   ...
   * @jsxobf-clobber
   */
  AreaSeries.DEFAULT_POINT_RADIUS = 4;
  ...
  AreaSeries_prototype.getPointRadius = function() {
    return this.pointRadius != null ? this.pointRadius : AreaSeries.DEFAULT_POINT_RADIUS;
  };
   ...
   * @private
   */
  AreaSeries_prototype.getDisplayedPointFill = function() {
   ...
   * @private
   */
  AreaSeries_prototype.getDisplayedPointStroke = function() {
   ...
   * @jsxobf-clobber
   */
  AreaSeries_prototype.storePointFillAndStroke = function() {
  ...
  AreaSeries_prototype.updateView = function() {
    ...
    var pointFill = this.getDisplayedPointFill();
    var pointStroke = this.getDisplayedPointStroke();
    ...
    for (var i = 0; i < points.length; i++) {
      ...
      if (renderer != null) {
        var thisFill = colorFunct != null ? colorFunct.call(null, record, index) : pointFill;
  ...
  AreaSeries_prototype.toString = function() {
    return "[AreaSeries '" + this.getName() + "']";
  };
