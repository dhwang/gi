...
jsx3.Class.defineClass("jsx3.chart.CategoryAxis", jsx3.chart.Axis, null, function(CategoryAxis, CategoryAxis_prototype) {
   ...
   * @jsxobf-clobber
   */
  CategoryAxis.VALID_TICKALIGNMENTS = {aligned: 1, between: 1};
  ...
  CategoryAxis_prototype.setTickAlignment = function( tickAlignment ) {
    if (CategoryAxis.VALID_TICKALIGNMENTS[tickAlignment]) {
   ...
   * @package
   */  
  CategoryAxis_prototype.getLabelTicks = function() {
    var numCategories = this.fetchTransient("trans_numCategories");
  ...
  CategoryAxis_prototype.toString = function() {
    return "[CategoryAxis '" + this.getName() + "' hor:" + this.horizontal + " pri:" + this.primary + "]";
  };
