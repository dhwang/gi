...
// @jsxobf-clobber-shared  getParallelValue getNormalValue getNormalWidth
...
jsx3.Class.defineClass("jsx3.chart.BCChart", jsx3.chart.CartesianChart, null, function(BCChart, BCChart_prototype) {
  ...
  BCChart.ALLOWED_TYPES = {clustered: 1, stacked: 1, stacked100: 1};
   ...
   * @jsxobf-clobber
   */
  BCChart_prototype.getParallelAxis = jsx3.Method.newAbstract();
   ...
   * @jsxobf-clobber
   */
  BCChart_prototype.getNormalAxis = jsx3.Method.newAbstract();
  ...
  BCChart_prototype.getParallelRange = function(series) {
    if (this.type == BCChart.TYPE_CLUSTERED) {
      var r1 = this.getRangeForField(series, "getParallelValue");
      var r2 = this.getRangeForField(series, "getMinValue");
      return this.getCombinedRange([r1, r2]);
    } else if (this.type == BCChart.TYPE_STACKED) {
      return this.getStackedRangeForField(series, "getParallelValue");
    } else if (this.type == BCChart.TYPE_STACKED100) {
      return this.getStacked100RangeForField(series, "getParallelValue");
    } else {
  ...
  BCChart_prototype.getNormalRange = function(series) {
    return this.getRangeForField(series, "getNormalValue");
  };
   ...
   * @package
   */
  BCChart_prototype.updateView = function() {
    this.jsxsuper();
    this.drawSeries();
  };
   ...
   * @package
   */
  BCChart_prototype.drawSeries = function() {
    ...
    var pAxis = this.getParallelAxis();
    var nAxis = this.getNormalAxis();
    ...
    if (this.type == BCChart.TYPE_STACKED100)
      categoryTotals = this.getCategoryTotals(series, "getParallelValue");
    ...
    for (var j = 0; j < numSeries; j++) {
      ...
      for (var i = 0; i < dp.length; i++) {
        ...
        if (jsx3.chart.isValueAxis(pAxis)) {
          var pValue = ser.getParallelValue(record);
      ...
      ser.updateView();
      root.appendChild(ser.getRenderRoot());
    }
  };
...
jsx3.Class.defineClass("jsx3.chart.BarChart", jsx3.chart.BCChart, null, function(BarChart, BarChart_prototype) {
  ...
  BarChart_prototype.getParallelAxis = function() {
    return this.getPrimaryXAxis();
  };

  BarChart_prototype.getNormalAxis = function() {
    return this.getPrimaryYAxis();
  };

  BarChart_prototype.toString = function() {
    return "[BarChart '" + this.getName() + "']";
  };
...
jsx3.Class.defineClass("jsx3.chart.ColumnChart", jsx3.chart.BCChart, null, function(ColumnChart, ColumnChart_prototype) {
  ...
  ColumnChart_prototype.getParallelAxis = function() {
    return this.getPrimaryYAxis();
  };

  ColumnChart_prototype.getNormalAxis = function() {
    return this.getPrimaryXAxis();
  };

  ColumnChart_prototype.toString = function() {
    return "[ColumnChart '" + this.getName() + "']";
  };
