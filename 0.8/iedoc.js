...
scriptFile = objFSO.GetFile("core\\scripts\\selenium-browserbot.js");
scriptFileStream = scriptFile.OpenAsTextStream(/*ForReading*/1);

eval(scriptFileStream.ReadAll());

 scriptFile = objFSO.GetFile("core\\scripts\\user-extensions.js");
 scriptFileStream = scriptFile.OpenAsTextStream(/*ForReading*/1);
