...
jsx3.Class.defineClass("jsx3.chart.LineSeries", jsx3.chart.Series, null, function(LineSeries, LineSeries_prototype) {
  ...
  LineSeries_prototype.updateView = function() {
    ...
    for (var i = 0; i < points.length; i++) {
      ...
      this._paintPoint(i, continuous, point[0], point[1], point[2], point[3], lx, ly);
   ...
   * @jsxobf-clobber
   */
  LineSeries_prototype._paintPoint = function(i, continuous, record, x, y, index, lx, ly) {
    var root = this.getCanvas();
    ...
    if (renderer != null) {
      ...
      var thisFill = colorFunct != null ? colorFunct.call(null, record, index) : this._getDisplayedPointFill();
