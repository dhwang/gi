...
// @jsxobf-clobber  _target _addin _loaded _server
...
window['jsx_main'] = function() {
  ...
  var BrowserDetect = function() {
    ...
    this.fx = this.gk && agt.indexOf('firefox') >= 0;
    if (this.fx) {
      var vers = this._getVersionAfter('firefox/');
...
//        jsx3._logIt("Add job " + objJob + " with pres [" + this._idToPres[id] + "]");
...
//        jsx3._logIt("... ran job " + objJob + " with result " + intCmd);
        ...
        } else if (intCmd == jsx3.util.Job.PUSH) {
          this._idsRunning[jobId] = false;
          return;
        } else {
      ...
      JobManager_prototype._onFinish = function(objJob) {
        var id = objJob.getId();
//        jsx3._logIt("_onFinish " + objJob + " (running:" + this._finishSP + ")");
...
//          jsx3._logIt("_finishThread " + jobId + " -> " + dependentJobs);
          if (dependentJobs) {
...
//              if (prereqs.length > 0)
//                jsx3._logIt("Job " + dependentJobId + " now has prereqs " + prereqs);
              this._runIfReady(dependentJobId);
            }
          }
        }
//          } catch (e) {
//          jsx3._logIt("Error in _finishThread: " + e);
//        }
...
//          jsx3._logIt("Publishing done!");
          if (this.publish)
            this.publish({subject:"done"});
        } else {
//          var ids = "";
//          for (var f in this._idsRunning)
//           ids += f+",";
//          jsx3._logIt("Not done! waiting:" + ids + " done:" + this._doneCt);
        }
      };
    };
    ...
    var defineJob = function(Job, Job_prototype) {
      ...
      Job_prototype.finish = function() {
        ...
        if (jsx3.lang.ClassLoader._ALLREQ[this._src] == this)
          jsx3.lang.ClassLoader._ALLREQ[this._src] = 1;
      };
      ...
      Job_prototype._checkAlreadyRequested = function() {
        var allReqs = jsx3.lang.ClassLoader._ALLREQ;

        if (allReqs[this._src] instanceof Job) {
//          jsx3._logIt("pushing " + this + " back on queue while waiting for " + allReqs[this._src]);
          this._manager.addPrereq(this.getId(), allReqs[this._src].getId());
          return Job.PUSH;
        } else if (allReqs[this._src]) {
//          jsx3._logIt(this + " is already done because the same file was already requested");
          return Job.DONE;
        }

        allReqs[this._src] = this;
      };
     ...
     * @jsxdoc-definition  jsx3.Class.defineClass("jsx3.lang.ClassLoader", Object, null, function(){});
     */
    ...
    var defineClassLoader = function(ClassLoader, ClassLoader_prototype) {
      ...
      proto.run = function() {
/* @JSC :: begin BENCH */
        if (jsx3.util && jsx3.util.Timer)
          var t1 = new jsx3.util.Timer("ClassLoader", this._src);
/* @JSC :: end */

        var retVal = this._checkAlreadyRequested();
...
/* @JSC :: end */
      ...
      /* XML job */
      ClassLoader.XmlJob = function(strId, strSrc, objCache, strCacheId, objClass) {
        this._id = strId || strSrc;
        this._src = strSrc;
      ...
      /* JSS job */
      ClassLoader.JssJob = function(strId, strSrc, objProps, objCache, strCacheId) {
        this._id = strId || strSrc;
        this._src = strSrc;
...
//          jsx3._logIt("Error loading JSS properties file " + this._src + ": " + doc.getError());
      ...
      /* PropsBundle job */
      ClassLoader.PropsBundleJob = function(strId, strSrc, objProps, objCache, objLocale) {
        this._id = strId;
        this._src = strSrc;
        this._props = objProps;
        this._cache = objCache;
      ...
      proto.run = function() {
        var doc = this._cache.getDocument(this._src);
      ...
      proto._finish = function(objEvent) {
        this._cache.setDocument(this._src, objEvent.target);
        this._props.addParent(jsx3.app.PropsBundle.getProps(this._src, this._locale, this._cache));
        this.finish();
      };
      ...
      ClassLoader.INCLUDES = [
        // NOTE: If the contents of this array change, double check the code near line 1064!!!
      ...
      ClassLoader._BROWSERS = {
        ie6:["ie6", ["IE","IE6","VML"], "allow"],
        ie7:["ie7", ["IE","IE7","VML"], "allow"],
        ie8:["ie7", ["IE","IE8","VML"]],
        fx1_5:["fx", ["FX","SVG","GKO"], "allow"],
        fx2:["fx", ["FX","FX2","SVG","GKO"], "allow"],
        fx3:["fx", ["FX","FX3","SVG","GKO"]],
        fx4:["fx", ["FX","FX4","SVG","GKO"]],
        sf3:["saf", ["SAF","SVG","KON"]],
        sf4:["saf", ["SAF","SVG","KON"]],
        op9:["ie", ["OPERA"]],
        op10:["ie", ["OPERA"]],
      ...
      ClassLoader_prototype.getTypes = function() {
        return ClassLoader._BROWSERS[this._type][1];
      };
...
/*            if (inc.type == "jss") {
              var src = ClassLoader._toAbsolute(jsx3.SYSTEM_ROOT + "/" + me.resolvePath(inc.src));
              var job = new ClassLoader.JssJob(inc.id, src, jsx3.System.JSS, jsx3.getSystemCache(), inc.id);
              allJsxJss[allJsxJss.length] = job.getId();
              this.getManager().addJob(job);
            } else */if (inc.type == "ljss" && jsx3.app.PropsBundle) {
              var src = ClassLoader._toAbsolute(jsx3.SYSTEM_ROOT + "/" + me.resolvePath(inc.src));
              var job = new ClassLoader.PropsBundleJob(inc.id, src, jsx3.System.LJSS, jsx3.getSystemCache());
              allJsxJss[allJsxJss.length] = job.getId();
...
/* @JSC :: begin BENCH */
          var t1 = new jsx3.util.Timer("ClassLoader", strURI);
/* @JSC :: end */
          ...
          for (var i = 0; i < includes.length; i++) {
            ...
            if (this.passesLoad(inc.onLoad || inc.load) &&
              ...
              if (inc.type == "css") {
                ...
                var job = new ClassLoader.JssJob(rsrcJobId, src, server.getProperties(), server.getCache(), (inc.id || inc.src));
                jobMgr.addJob(job);
                xmlIds[xmlIds.length] = job.getId();
              } else if (inc.type == "ljss") {
                var job = new ClassLoader.PropsBundleJob(rsrcJobId, src, server.LJSS, server.getCache(), server.getLocale());
                jobMgr.addJob(job);
                xmlIds[xmlIds.length] = job.getId();
              }
            }
...
//            jsx3._logIt("Painting " + objApp._server);
      ...
      ClassLoader_prototype._onAddinConfigLoaded = function(objXML, strKey) {
        ...
        if (addinIncludes != null) {
          var lastJsJobId = ["jsx.js", "logger.init", "jsx.xml"];
          ...
          for (var i = 0; i < addinIncludes.length; i++) {
            ...
            if (this.passesLoad(include.onLoad || include.load) && this._passesBrowser(include.browser)) {
              ...
              if (include.type == 'script') {
                var job = jobManager.addJob(new ClassLoader.JsJob(rsrcJobId,  src), lastJsJobId);
                job._subscribe("finish", this, "_onJsJobFinished");
                lastJsJobId = job.getId();
              } else if (include.type == 'css') {
                var job = jobManager.addJob(new ClassLoader.CssJob(rsrcJobId,  src));
                jobManager.addPrereq(jobPrefix + ".css", job.getId());
              } else if (include.type == 'jss') {
                var job = jobManager.addJob(new ClassLoader.JssJob(rsrcJobId,  src, jsx3.System.JSS, jsx3.getSystemCache(), (include.id || src)));
                jobManager.addPrereq(jobPrefix + ".jss", job.getId());
              } else if (inc.type == "ljss") {
                var job = jobManager.addJob(new ClassLoader.PropsBundleJob(rsrcJobId, src, jsx3.System.JSS,
                    server.getSystemCache(), jsx3.System.getLocale()));
                jobManager.addPrereq(jobPrefix + ".jss", job.getId());
              }
            }
          }
              ...
              '<div style="padding: 4px;">'+
                ...
                '<div style="padding:6px 0px 0px 0px;font-size:10px;font-family:Verdana,sans-serif;">@gi.runtime.notsupported@' +
                   '<div style="color:#000033;padding:8px 0px 0px 0px;margin:0px 0px 0px -2px;">'+
                     '<span style="font-size:8px;">&gt; </span><a style="color:#000033;" href="http://power.tibco.com/gi/builderlink/sysreqs35/" target="_blank">@gi.boot.seefullreqs@</a>'+
