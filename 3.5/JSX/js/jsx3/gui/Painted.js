...
// @jsxobf-clobber-shared  _jsxdynamic _doLoad
...
/* @JSC :: begin BENCH */
    ...
    while (queue.length > 0) {
      ...
      var paints = 1 + (Painted.REPAINT_MAP.get(node.getId()) || Number(0));
      if (paints > 1) {
      ...
      Painted.REPAINT_MAP.set(node.getId(), paints);
    }
/* @JSC :: end */
...
/* @JSC :: begin BENCH */
    queue.subscribe("done", function() { t1.log("update box chunked");});
/* @JSC :: end */
