...
jsx3.Class.defineClass("jsx3.gui.Table", jsx3.gui.Block, [jsx3.gui.Form, jsx3.xml.Cacheable, jsx3.xml.CDF], function(Table, Table_prototype) {
  ...
  Table_prototype._getRecordByIndex = function(intColumnIndex) {
    return this.getColumnProfileDocument().selectSingleNode("//record[" + (intColumnIndex + 1) + "]");
  };
  ...
  Table_prototype.updateBoxProfile = function(objImplicit, objGUI, objQueue) {
    ...
    jsx3.sleep(function() {this._sychronizeColumnWidths(objGUI);},"syncheadtobody",this);
  };
  ...
  Table_prototype._paintHead = function(objGUI) {
    ...
    if(intHeaderHeight) {
      ...
      if (objTRBody != null) {
        ...
        } while (objTRBody && objTRBody.tagName.search(/^tr/i) == -1);
      ...
      if (objTRBody != null) {
        ...
        if (objTRBody) {
          ...
          for (var i = 0; i < objTRBody.childNodes.length; i++) {
            var offsetWidthB = objTRBody.childNodes[i].offsetWidth;
...
/* @JSC :: end */
  ...
  Table_prototype.getHeaderClass = function(strDefault) {
    return (this.jsxheaderclass) ? this.jsxheaderclass : ((strDefault) ? strDefault : null);
  };
...
/* @JSC :: end */
    ...
    var baseDoc = jsx3.getSharedCache().getOrOpenDocument(Table.DEFAULTXSLURL, null, jsx3.xml.XslDocument.jsxclass);
