...
jsx3.Class.defineClass('jsx3.gui.Window', jsx3.app.Model, null, function(Window, Window_prototype) {
  ...
  Window.HTML_URI = new jsx3.net.URI("jsx3.gui.window.html");
  /** @private @jsxobf-clobber */
  Window.HTML_URI_XHTML = new jsx3.net.URI("jsx3.gui.window.xhtml");
...
/* @JSC */ }
  ...
  Window_prototype.open = function() {
    if (this._jsxwindow != null && !this._jsxwindow.closed) {
      ...
      var w = window.open(uri.toString(), this.getId().replace(/\./g,""),
          "directories=no," +
          "location=no," +
          "menubar=no," +
          "status=yes," +
