...
/* @JSC :: end */
  ...
  jsx3.html.loadImages("jsx:///images/menu/bg.gif", Menu._IMAGEDOWNMENU, Menu._IMAGEOFFMENU, Menu._IMAGEONMENU,
  ...
  Menu_prototype._focusItem = function(objEvent, itemGUI, intLevel) {
    ...
    if (itemGUI.getAttribute("jsxdisabled") != "1") {
      ...
      itemGUI.parentNode.parentNode.focus();
    }
  ...
  Menu_prototype._onLoseFocus = function(objEvent) {
    jsx3.sleep(function() { this._hideMenu(1, true); }, "jsx3.gui.Menu.loseFocus", this);
  };
  ...
  Menu_prototype._hideMenu = function(intIndex, bNoFocus) {
    if (this != Menu._ACTIVE_MENU) return;
