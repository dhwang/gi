...
/* @JSC :: end */
 ...
 Block.DEFAULTFONTNAME = "Verdana";
   ...
   * @param intDisplay {String} one of jsx3.gui.Block.DISPLAYNONE (display:none;) and jsx3.gui.Block.DISPLAYBLOCK (display:;)
   * @param bRepaint {boolean} if <code>true</code>, the view of this object is immediately updated, obviating the need to call <code>repaint()</code>.
   * @return {jsx3.gui.Block} this object
   */
  Block_prototype.setDisplay = function(intDisplay, bRepaint) {
    if (this.jsxdisplay != intDisplay) {
      //update the MODEL
      this.jsxdisplay = intDisplay;
      ...
      if (bRepaint) {
        ...
        if (intDisplay != Block.DISPLAYNONE) {
          ...
          if(!(this.getRelativePosition() == Block.ABSOLUTE || (b1 && b1.getBoxType() != "relativebox"))) {
            ...
            if(oX.length == 2) intDisplay = oX[1];
          }
        }
        this.updateGUI("display",intDisplay);
      }
    }
...
/* @JSC :: end */
   ...
   * @param bRepaint {boolean} whether to update the display of this object immediately. If <code>left</code> is
...
/* @JSC :: end */
   ...
   * @return {jsx3.gui.Block} this object
   */
  Block_prototype.setRelativePosition = function(intRelative, bRepaint) {
