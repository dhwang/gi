...
/* @JSC */ }
    ...
    b1f.setAttributes(this.renderHandler("scroll", "_ebScrollV") + this.renderHandler("mouseover", "_ebMouseOverVScroll") +
                      ...
                      this.renderHandler("mousedown", "_ebMouseDownV") + jsx3.html._UNSEL + ' class="jsx30matrix_scrollv"');
    ...
    //configure hscroller
    var b1g = b1.getChildProfile(3);
    b1g.setAttributes(this.renderHandler("scroll", "_ebScrollH") + this.renderHandler("mousedown", "_ebMouseDownH") + jsx3.html._UNSEL + ' class="jsx30matrix_scrollh"');
...
/* @JSC :: end */
      ...
      var html = '<div id="' + this.getId() + '_masks" class="jsx30matrix_masks">' + this.paintChildren(masksToPaint) + "</div>";
/* @JSC :: begin BENCH */
      t1.log("paint masks");
/* @JSC :: end */
      return html;
...
/* @JSC :: end */
  ...
  Matrix_prototype._doStartReorder = function(objEvent,objGUI) {
    ...
    if (objEvent.leftButton() && intDisplayIndex >= this.getFixedColumnIndex(0) && this.getCanReorder() != jsx3.Boolean.FALSE) {
      ...
      var strGhost = '<table id="' + this.getId() + '_ghost" cellspacing="0" cellpadding="0" class="jsx30matrix_ghost" style="width:' + parseInt(objGUI.offsetWidth) + 'px;"><tr>' + jsx3.html.getOuterHTML(objGUI) + '</tr></table>';
...
/*
    if (bCancel) {
      var v = this.getValue();
      bCancel = !(v == null || (v instanceof Array && v.length == 0));
    }
*/
...
//    jsx3.log("wheel: " + objEvent);
            ...
            for (var i=0;i<strIds.length;i++) {
              ...
              if (!(this == objSource && objContext && this._isDescendantOrSelf(this.getRecordNode(objContext.row.getAttribute("jsxid")),this.getRecordNode(strIds[i])))) {
                ...
                if (bInsertBefore) {
                  ...
                  var objRecord = this.adoptRecord(objSource,strIds[i],(this.getRenderingModel() == Matrix.REND_HIER && objContext)?objContext.row.getAttribute("jsxid"):null,objContext != null);
                }
              }
            }
  ...
  Matrix_prototype._scrollIntoView = function(objReference) {
    ...
    if(objGUI) {
      var objP = jsx3.html.getRelativePosition(this._getViewPane(objGUI),objReference);
...
/* @JSC :: begin BENCH */
    var t = new jsx3.util.Timer(Matrix.jsxclass, this);
/* @JSC :: end */
...
jsx3.Class.defineInterface("jsx3.gui.Matrix.DialogMask", jsx3.gui.Matrix.BlockMask,
  ...
  DialogMask_prototype.emBeginEdit = function(strValue, objTdDim, objPaneDim, objMatrix, objColumn, strRecordId, objTD) {
    ...
    var panePos = jsx3.html.getRelativePosition(containerDiv, containerDiv);
    var offsetPos = jsx3.html.getRelativePosition(containerDiv, objTD);
    ...
    jsx3.html.updateCSSOpacity(this.getRendered(), 0.90);
