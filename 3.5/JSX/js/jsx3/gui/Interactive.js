...
//      jsx3.log("cancelling move because button=" + objEvent.event().button);
  ...
  Interactive_prototype.showSpy = function(strHTML,intLeft,intTop) {
    if (strHTML != null) {
      ...
      strHTML = '<span onmouseout="if (event.toElement != this.childNodes[0]) jsx3.gui.Interactive.hideSpy();" class="jsx30spyglassbuffer"><div class="jsx30spyglass">' + strHTML + '</div></span>';
