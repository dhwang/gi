...
jsx3.Class.defineClass("jsx3.gui.ColorPicker", jsx3.gui.Block, [jsx3.gui.Form],
  ...
  ColorPicker_prototype.paint = function() {
    ...
    b1.setAttributes('id="' + this.getId() + '" class="jsx30colorpicker" ' + 'label="' + this.getName() + '" ' +
                      this.paintIndex() + this.paintTip() + strAttributes + jsx3.html._UNSEL);
    ...
    b1a.setAttributes(this.renderHandler(Event.MOUSEDOWN, "_eb2DMouseDown", 2) + jsx3.html._UNSEL);
    var b1b = b1i.getChildProfile(1);
    b1b.setAttributes(this.renderHandler(Event.MOUSEDOWN, "_eb1DMouseDown", 2) + jsx3.html._UNSEL);
    ...
    var spanStart = '<span' + jsx3.html._UNSEL + ' class="gradient" style="width:';
  ...
  ColorPicker_prototype._paintGradientImage = function(strURL, intW, intH) {
    if (jsx3.CLASS_LOADER.IE6) {
      return '<span' + jsx3.html._UNSEL + ' class="gradient" style="width:' + intW + 'px;height:' + intH + 'px;' +
          'filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'' + strURL + '\', sizingMethod=\'scale\');"></span>';      
    } else {      
      return '<img src="' + strURL + '"' + jsx3.html._UNSEL + ' class="gradient" style="width:' + intW + 'px;height:' + intH + 'px;"/>';
    }    
  };
