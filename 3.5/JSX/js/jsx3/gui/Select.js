...
/* @JSC :: end */
  ...
  Select_prototype._ebKeyDownCombo = function(objEvent, objGUI) {
    ...
    if (!bMod && (objEvent.downArrow() || objEvent.enterKey())) {
      ...
      if (!objEvent.enterKey() && content && content.getAttribute("jsxselid") == this.getId()) {
...
/* @JSC :: end */
  ...
  Select._getMode = function() {
    var intMode = jsx3.html.getMode();
    if (intMode == jsx3.html.MODE_IE_STRICT && jsx3.CLASS_LOADER.IE7)
      intMode += "x";
    return intMode;
  };
...
//    jsx3.log("_checkLoseFocus " + objEvent.event.getType() + " " + jsx3.html.getOuterHTML(focusedElm));
  ...
  Select_prototype.paint = function() {
    ...
    if (this.getXmlAsync()) this.getXML();
    ...
    if(this.getType() == Select.TYPESELECT) {
      var b1b = b1a.getChildProfile(0);
      b1b.setAttributes(' jsxtype="Text" class="jsx30select_text"' + jsx3.html._UNSEL);
