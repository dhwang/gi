...
<xsl:stylesheet version="2.0"
  ...
  <xsl:output
    ...
    <html>
      <head>
        <title>TIBCO General Interface<xsl:value-of disable-output-escaping="yes">&amp;trade;</xsl:value-of> @build.gi.version.name@ -
      ...
      <body>
        ...
        <h1>TIBCO General Interface<xsl:value-of disable-output-escaping="yes">&amp;trade;</xsl:value-of> @build.gi.version.name@
