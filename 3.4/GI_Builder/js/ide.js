...
jsx3.ide.onStartUp2 = function() {
  ...
  if (myProject) {
    ...
    queue.addJob(function(q) { jsx3.ide.adjustSplittersOnStartup(); });
...
jsx3.ide.openPreviouslyOpenFiles = function() {
  ...
  var alert = jsx3.IDE.alert(
		"Opening Project " + jsx3.ide.SERVER.getRelPath(),
		"Opening project files...<br/><br/>" + 
		"To start General Interface&#8482; Builder without opening files, hold down CTRL during launch.<br/><br/>" +
		"To start General Interface&#8482; Builder without opening a project, hold down CTRL+ALT during launch.",
...
jsx3.ide.writeUserXmlFile = function(objFile, objDoc) {
  ...
  if (prefs.addcharset) {
    if (encodeCharset && objFile.write(this.makeXmlCloseTags(objDoc.serialize(true, encodeCharset)),
        encodeCharset, prefs.outputlinesep, false))
      return true;
    else
      return objFile.write(this.makeXmlCloseTags(objDoc.serialize()), null, prefs.outputlinesep, true);
  } else {
    return objFile.write(this.makeXmlCloseTags(objDoc.serialize()), encodeCharset, prefs.outputlinesep, true);
  }
};
