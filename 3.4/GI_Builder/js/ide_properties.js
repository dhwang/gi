...
jsx3.ide.onDPEdit = function(objGrid, objColumn, strRecordId, strValue) {
  if (objColumn.getPath() == "jsxid") {
    // TODO: ???
    objGrid.redrawRecord(strRecordId);
  }
};
...
jsx3.ide.openColorPickerMask = function(objMask) {
  ...
  preview.setHeight(preview.getHeight() - 46);
