...
jsx3.Class.defineClass("jsx3.chart.AreaChart", jsx3.chart.CartesianChart, null, function(AreaChart, AreaChart_prototype) {
  ...
  AreaChart_prototype.setType = function( type ) {
    if (AreaChart.ALLOWED_TYPES[type]) {
      this.type = type;
    } else {
   ...
   * @package
   */
  AreaChart_prototype.updateView = function() {
    this.jsxsuper();
    this.drawSeries();
  };
   ...
   * @package
   */
  AreaChart_prototype.drawSeries = function() {
  ...
  AreaChart_prototype.toString = function() {
    return "[AreaChart '" + this.getName() + "']";
  };
