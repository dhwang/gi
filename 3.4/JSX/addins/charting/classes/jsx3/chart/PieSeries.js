...
jsx3.Class.defineClass("jsx3.chart.PieSeries", jsx3.chart.Series, null, function(PieSeries, PieSeries_prototype) {
   ...
   * @private
   */
  PieSeries.LABEL_PLACEMENTS = {top: 1, right: 1, bottom: 1, left: 1};  
  ...
  PieSeries_prototype.setLabelPlacement = function( labelPlacement ) {
    if (PieSeries.LABEL_PLACEMENTS[labelPlacement]) {
  ...
  PieSeries_prototype.getFillForIndex = function( record, index ) {
    ...
    if (funct != null)
      return funct.call(null, record, index);
   ...
   * @jsxobf-clobber
   */
  PieSeries_prototype.getStrokeForIndex = function( index ) {
  ...
  PieSeries_prototype.updateView = function() {
    ...
    for (var i = 0; i < slices.length; i++) {
      ...
      shape.setStroke(this.getStrokeForIndex(i));
      ...
      if (funct != null)
        shape.setToolTip(funct.call(null, this, record, percent));
    }
    ...
    if (label != null && label.getDisplay() != jsx3.gui.Block.DISPLAYNONE) {
      ...
      label.updateView();
      root.appendChild(label.getRenderRoot());
    }
  };
  ...
  PieSeries_prototype.toString = function() {
    return "[PieSeries '" + this.getName() + "']";
  };
