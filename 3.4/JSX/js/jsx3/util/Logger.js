...
jsx3.Class.defineClass('jsx3.util.Logger', null, null, function(Logger, Logger_prototype) {
  ...
  Logger_prototype.addHandler = function(objHandler) {
    if (this._handlers == null) this._handlers = new jsx3.util.List();
    this._handlers.add(objHandler);
  };
  ...
  Logger_prototype._updateLevel = function() {
    ...
    if (newValue != this._level) {
      ...
      if (this._children != null) {
        for (var i = this._children.iterator(); i.hasNext(); )
          i.next()._updateLevel();
      }
    }
  };
  ...
  Logger_prototype.setParent = function(objParent) {
    ...
    if (this._parent != null) {
      if (this._parent._children == null)
        this._parent._children = new jsx3.util.List();
  ...
  Logger_prototype._dispatch = function(objRecord) {
    ...
    while (logger != null) {
      if (logger._handlers != null) {
        for (var i = logger._handlers.iterator(); i.hasNext(); ) {
...
jsx3.Class.defineClass('jsx3.util.Logger.Manager', null, null, function(Manager, Manager_prototype) {
  ...
  Manager_prototype.initialize = function(objXML) {
    ...
    if (objXML.hasError()) {
      window.alert(jsx3._msg("logr.err_conf", objXML.getError()));
      objXML.loadXML("<configuration/>");
    }

    this._config = objXML;

    var handlerNames = this._initHandlers();
    this._wireNewHandlers(handlerNames);
  };
  ...
  Manager_prototype._initBean = function(obj, objNode) {
    ...
    for (var i = objNode.selectNodeIterator("./property"); i.hasNext(); ) {
      ...
      if (objSetter != null) {
        if (bEval) {
          try {
            strValue = isNaN(strValue) ? jsx3.eval(strValue) : Number(strValue);
          } catch (e) {
