...
/* @JSC :: end */
  ...
  ToolbarButton_prototype.paint = function() {
    ...
    if ((myKeyBinding = this.getKeyBinding()) != null) {
      ...
      this._jsxhotkey.setEnabled(this.getEnabled() != Form.STATEDISABLED);
    }
   ...
   * @jsxobf-clobber
   */
  ToolbarButton_prototype.paintCursor = function() {
    return (this.getEnabled() == Form.STATEENABLED) ? "cursor:pointer;" : "cursor:default;";
  };
