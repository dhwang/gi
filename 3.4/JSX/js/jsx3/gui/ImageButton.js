...
jsx3.Class.defineClass('jsx3.gui.ImageButton', jsx3.gui.Block, [jsx3.gui.Form], function(ImageButton, ImageButton_prototype) {
  ...
  ImageButton_prototype.paint = function() {
    ...
    if (myKeyBinding) {
      ...
      this._jsxhotkey.setEnabled(bEnabled);
    }
    ...
    b1.setStyles(this.paintCursor() + this.paintVisibility() + this.paintDisplay() + this.paintZIndex() +
  ...
  ImageButton_prototype.createBoxProfile = function() {
    ...
    var o = {};
    if (!bRelative && !jsx3.util.strEmpty(this.getLeft())) o.left = this.getLeft();
    if (!bRelative && !jsx3.util.strEmpty(this.getTop())) o.top = this.getTop();
    if (!(this.getWidth() == null || isNaN(this.getWidth()))) o.width = this.getWidth();
    if (!(this.getHeight() == null || isNaN(this.getHeight()))) o.height = this.getHeight();
    o.tagname = "span";
    o.boxtype = (bRelative || o.left == null || o.top == null) ? "relativebox" : "box";
    if (this.getPadding() != null) o.padding = this.getPadding();
    if (bRelative && this.getMargin() != null) o.margin = this.getMargin();
    if (this.getBorder() != null) o.border = this.getBorder();
