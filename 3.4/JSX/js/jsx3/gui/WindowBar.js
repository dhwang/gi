...
jsx3.Class.defineClass("jsx3.gui.WindowBar", jsx3.gui.Block, null, function(WindowBar, WindowBar_prototype) {
  ...
  WindowBar_prototype.doBeginMove = function(objEvent, objGUI) {
    // so that events on buttons in this window bar do not start a move sequence
    if (jsx3.html.getJSXParent(objEvent.srcElement()) == this)
  ...
  WindowBar_prototype.createBoxProfile = function(objImplicit) {
    ...
    if(objImplicit.height == null) objImplicit.height = WindowBar.DEFAULTHEIGHT;
    objImplicit.boxtype = bRelative ? "inline" : "box";
    objImplicit.tagname = "div";
    objImplicit.padding = "0 0 0 4";
