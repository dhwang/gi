...
// @jsxobf-clobber-shared  _jsxdynamic
...
jsx3.Class.defineClass("jsx3.gui.Painted", jsx3.app.Model, null, function(Painted, Painted_prototype) {
  ...
  Painted_prototype.getAbsolutePosition = function(objRoot, objGUI) {
    ...
    return jsx3.html.getRelativePosition(objRoot, objGUI);
  };
   ...
   */
  Painted_prototype.setDynamicProperty = function(strName, strValue) {
    //declare object if it doesn't exists
  ...
  Painted_prototype.renderAttributes = function(objExclude, bSkipEvents) {
    ...
    if (this.jsxcustom != null) {
      var bInter = jsx3.gui.Interactive && this.instanceOf(jsx3.gui.Interactive);
      ...
      for (var p in this.jsxcustom) {
        var bSkip =
            ...
            (bSkipEvents && bInter && jsx3.gui.Interactive.isBridgeEventHandler(p));
  ...
  Painted_prototype.focus = function() {
    ...
    if (objGUI != null && objGUI.focus) objGUI.focus();
    return objGUI;
  };
...
//
        ...
        jsx3.html.setOuterHTML(objGUI, strHTML);
   ...
   * <p/>
   *
   * @param {HTMLElement} the rendered HTML element representing this object.
   * @since 3.4
   * @protected
   */
  ...
  Painted_prototype.paintDomHolder = function() {
    return '<span id="' + this.getId() + '" style="display:none;"></span>';
  };
   ...
   */
  Painted_prototype.paintChild = function(objChild, bGroup, objGUI) {
    ...
    if (objGUI != null) {
      if (objChild.isDomPaint()) {
        ...
        jsx3.html.insertAdjacentHTML(objGUI, "beforeEnd", objChild.paint());
...
//        jsx3.log("Escaped updating children: " + this.getChildren());
  ...
  Painted_prototype._updateBoxFromQueue = function(objQueue, objImplicit, objGUI) {
    var b = this.getBoxProfile(false);
...
/** @package */
jsx3.Class.defineClass("jsx3.gui.Painted.Queue", jsx3.lang.Object, null, function(Queue, Queue_prototype) {
...
//      if (Queue._TS == null) Queue._TS = new Date().getTime();
      ...
      if (q != null) {
        ...
        jsx3.log("Queue finished " + (new Date().getTime() - Queue._TS) + "ms");
        var t = Queue._TS;
        window.setTimeout(function() {jsx3.log("... timeout " +  (new Date().getTime() - t) + "ms"); }, 0);
        delete Queue._TS;
      }*/
...
jsx3.Class.defineClass("jsx3.gui.Painted.Box", jsx3.lang.Object, null, function(Box, Box_prototype) {
  ...
  /** @private @jsxobf-clobber */
  Box._CSS_FIXES = ["", "display:-moz-inline-box;", "display:inline-block;", "display:-moz-inline-box;"];

  /** @package */
  Box.getCssFix = function() {
    return Box._CSS_FIXES[jsx3.html.getMode()];
  };
  ...
  Box_prototype.paint = function() {
    ...
    var commonPrefix = '<' + this._expl.tagname + ' ' + this.attributes;
    ...
    myWidth = myWidth != null ? "width:" + Math.max(0, myWidth) + "px;" : "";
    var myHeight = this.getPaintedHeight();
    myHeight = myHeight != null ? "height:" + Math.max(0, myHeight) + "px;" : "";

    var endTag = (this._expl.empty) ? '"/>' : '">';

    if (this._expl.boxtype == "box") {
      var myLeft = this._expl.left;
      myLeft = myLeft == null ? "left:0px;" : "left:" + myLeft + "px;";
      var myTop = this._expl.top;
      myTop = myTop == null ? "top:0px;" : "top:" + myTop + "px;";
      var position = this.implicit.omitpos ? "" : "position:absolute;";

      a[0] = commonPrefix + ' style="' + position + myWidth + myHeight + myLeft + myTop + this.paintPadding() +
          this.paintMargin() + this.paintBorder() + this.styles + endTag;
    } else if (this._expl.boxtype == "relativebox") {
      var position = this.implicit.omitpos ? "" : "position:relative;";
      a[0] = commonPrefix + ' style="' + position + this._getCSSFix() + myWidth + myHeight + this.paintPadding() +
          this.paintMargin() + this.paintBorder() + this.styles + endTag;
    } else {
      //resolve nulls
      var myLeft = this._expl.left;
      myLeft = myLeft == null ? "" : "left:" + myLeft + "px;";
      var myTop = this._expl.top;
      myTop = myTop == null ? "" : "top:" + myTop + "px;";
      var position = this.implicit.omitpos ? "" : "position:relative;";
    ...
    a[1] = (this._expl.empty) ? '' : '</' + this._expl.tagname + '>';
    return a;
  };
  ...
  Box_prototype._getCSSFix = function() {
    ...
    return (this._expl.container &&
        (jsx3.html.getMode() == jsx3.html.MODE_FF_STRICT || jsx3.html.getMode() == jsx3.html.MODE_FF_QUIRKS)) ?
           "" : Box.getCssFix();
  };
  ...
  Box_prototype._isParentIndependent = function() {
    var i = this.implicit;
    return (typeof(i.width) != "string" || i.width.indexOf("%") < 0) &&
           (typeof(i.height) != "string" || i.height.indexOf("%") < 0) &&
           (typeof(i.left) != "string" || i.left.indexOf("%") < 0) &&
           (typeof(i.top) != "string" || i.top.indexOf("%") < 0);
  };
   ...
   * @package
   */
  Box_prototype.recalculate = function(profile, objGUI, objQueue) {
    ...
    for (var p in profile) {
      if (this.implicit[p] != profile[p]) {
        ...
        if (!w && (p == "width" || p == "parentwidth")) w = 1;
        if (!h && (p == "height" || p == "parentheight")) h = 1;
      }
    }
    ...
    if (bUpdate) {
      ...
      if (objGUI) {
        ...
        if (this._expl.boxtype == "box" && this._expl.left != null && this._expl.top != null) {
          if (parseInt(objStyle.left) != this._expl.left) {
            objStyle.left = this._expl.left + "px"; // NOTE: Fx XHTML mode requires "px"
            l = 1;
          }
          if (parseInt(objStyle.top) != this._expl.top) {
            objStyle.top = this._expl.top + "px";
            t = 1;
          }
        }
        ...
        if (profile.parentheight != null || profile.parentwidth != null ||
          ...
          if (myWidth != null && parseInt(objStyle.width) != myWidth) {
            objStyle.width = Math.max(0, myWidth) + "px";
            w = 1;
          } else {
            w = 0;
          }
          ...
          if (myHeight != null && parseInt(objStyle.height) != myHeight) {
            objStyle.height = Math.max(0, myHeight) + "px";
            h = 1;
          } else {
            h = 0;
          }
...
//    jsx3.log("recalculate " + bUpdate + " " + (objGUI ? (objGUI.id + " " + jsx3.GO(objGUI.id)) : "-") + " " + [l,t,w,h].join(","));
  ...
  Box_prototype.calculate = function(arrFields) {
    ...
    for (var i = 0; i < arrFields.length; i++) {
      ...
      if (Box._LT_PROPS[pname] && (pvalue == null || pvalue == "") && this.implicit.boxtype == "box") {
        newBox[pname] = 0;
      } else {
  ...
  Box_prototype._addPropLeft = function(value) {
    this._expl.left = typeof(value) == "string" && value.indexOf("%") >= 0 ?
  ...
  Box_prototype._addPropTop = function(value) {
    this._expl.top = typeof(value) == "string" && value.indexOf("%") >= 0 ?
...
/* @JSC :: begin DEP */
    if (typeof(value) == "string" && value.indexOf(":") >= 0) {
      ...
      if (typeof(cssFix) != "object") // error condition
        arrBorder = cssFix.split(";");
    } else {
/* @JSC :: end */
      value = value.replace(/(^[;\s]*)|([;\s]*$)/g, "");
      if (value !== "")
        arrBorder = value.split(";");
/* @JSC :: begin DEP */
    }
/* @JSC :: end */
    ...
    if (arrBorder == null) {
      ...
      this._expl.border = arrBorder[0] ? "border:" + (arrWidth[0] > 0 ? arrBorder[0] : "0px") + ";" : "";
    } else if (arrBorder.length == 4) {
      this._expl.border =
          (arrBorder[0] ? "border-top:" + (arrWidth[0] > 0 ? arrBorder[0] : "0px") + ";" : "") +
          (arrBorder[1] ? "border-right:" + (arrWidth[1] > 0 ? arrBorder[1] : "0px") + ";" : "") +
          (arrBorder[2] ? "border-bottom:" + (arrWidth[2] > 0 ? arrBorder[2] : "0px") + ";" : "") +
          (arrBorder[3] ? "border-left:" + (arrWidth[3] > 0 ? arrBorder[3] : "0px") + ";" : "");
    }
...
/* @JSC :: begin DEP */
    if (typeof(value) == "string" && value.indexOf(":") > -1) {
      ...
      var cssFix = Box.cssToJsx(value, "margin");
      if (typeof(cssFix) != "object") // error condition
...
/* @JSC :: end */
    ...
    if (arrWidth == null)
      ...
      this._expl.margin = "margin:" + arrWidth[0] + "px;";
    else
      this._expl.margin = "margin:" + arrWidth[1] + "px " + arrWidth[2] + "px " +
                                      arrWidth[3] + "px " + arrWidth[4] + "px;";
...
/* @JSC :: begin DEP */
    if (typeof(value) == "string" && value.indexOf(":") > -1) {
      //old css syntax is probably being used; convert
      var cssFix = Box.cssToJsx(value, "padding");
      if (typeof(cssFix) != "object") // error condition
        //convert the implied string to a parsed equivalent (creates a 5 element array)
        arrWidth = cssFix.match(Box.REGEX);
    } else {
...
/* @JSC :: end */
    ...
    if (arrWidth == null) {
      ...
      var w = arrWidth[0];
      arrInt = [w, w, w, w];
      this._expl.padding = "padding:" + w + "px;";
    } else {
      arrInt = [];
      for (var i = 1; i < 5; i++) {
      ...
      this._expl.padding = "padding:" + arrInt[0] + "px " + arrInt[1] + "px " +
                                        arrInt[2] + "px " + arrInt[3] + "px;";
    }
  ...
  Box_prototype.getPaintedWidth = function() {
    ...
    var mode = jsx3.html.getMode();
    var val = mode == jsx3.html.MODE_IE_QUIRKS ||
        ((type == "text" || type == "password" || this._expl.tagname == "textarea") && mode == jsx3.html.MODE_FF_QUIRKS) ?
  ...
  Box_prototype.paintMargin = function() {
    return this._expl.margin || String("");
  };
  ...
  Box_prototype.paintPadding = function() {
    return this._expl.padding || String("");
  };
  ...
  Box_prototype.paintBorder = function() {
    return this._expl.border || String("");
  };
  ...
  Box.getScrollSize = function(objServerContainer) {
    if (Box.SCROLL_SIZE == null) {
      ...
      var test0 = '<div id="_jsx3_gui_painted_box_0" class="jsx30block" style="padding:0px;margin:0px;border-width:0px;position:absolute;width:100px;height:100px;left:-100px;top:-100px;overflow:scroll;">&#160;</div>';
      jsx3.html.insertAdjacentHTML(objBody, "beforeEnd", test0);
      Box.SCROLL_SIZE = 100 - parseInt(document.getElementById("_jsx3_gui_painted_box_0").clientWidth);
    }
  ...
  Box.getScrollSizeOffset = function(strCSS) {
    ...
    return jsx3.html.getScrollSizeOffset(intSize,strCSS);
  };
...
/* @JSC :: begin DEP */
  ...
  Box.cssToJsx = function(strInput,cssEl) {
    ...
    var re = (cssEl=="padding")? rePadding : reMargin;
    var splited = strInput.split(";");

    if (splited) {
      for (var i = 0  ; i < splited.length ; i++) {
        // By spliting the rule semicolon is removed, also add it again
        var singlematched = splited[i]+";";
  ...
  /** @private @jsxobf-clobber */
  Box.cssBorderToJsx = function(strInput) {
    var output = "not matched";
    var top = ["0px", "solid", ""];
    var right = ["0px", "solid", ""];
    var bottom = ["0px", "solid", ""];
    var left = ["0px", "solid", ""];
    var width="";
    var style="";
    var color="";
    ...
    // Test for semicolon
    var reSemicolon = /border\s*.*[^;]\s*border/ig;
    // Test for width
    var re1= /^(\d+)(px)?$/i;
    // Test for style
    var re2= /^(dashed|dotted|double|groove|hidden|inset|none|outset|ridge|solid)$/i;
    // Test for color
    var re3= /^(#[a-zA-Z0-9]{6}|rgb\s*\(\s*\d{1,3}%?\s*,\s*\d{1,3}%?\s*,\s*\d{1,3}%?\s*\)|(AliceBlue|AntiqueWhite|Aqua|Aquamarine|Azure|Beige|Bisque|Black|BlanchedAlmond|Blue|BlueViolet|Brown|BurlyWood|CadetBlue|Chartreuse|Chocolate|Coral|CornflowerBlue|Cornsilk|Crimson|Cyan|DarkBlue|DarkCyan|DarkGoldenrod|DarkGray|DarkGreen|DarkKhaki|DarkMagenta|DarkOliveGreen|DarkOrange|DarkOrchid|DarkRed|DarkSalmon|DarkSeaGreen|DarkSlateBlue|DarkSlateGray|DarkTurquoise|DarkViolet|DeepPink|DeepSkyBlue|DimGray|DodgerBlue|FireBrick|FloralWhite|ForestGreen|Fuchsia|Gainsboro|GhostWhite|Gold|Goldenrod|Gray|Green|GreenYellow|Honeydew|HotPink|IndianRed|Indigo|Ivory|Khaki|Lavender|LavenderBlush|LawnGreen|LemonChiffon|LightBlue|LightCora|LightCyan|LightGoldenrodYellow|LightGreen|LightGrey|LightPink|LightSalmon|LightSeaGreen|LightSkyBlue|LightSlateGray|LightSteelBlu|LightYellow|Lime|LimeGreen|Linen|Magenta|Maroon|MediumAquamarine|MediumBlue|MediumOrchid|MediumPurple|MediumSeaGreen|MediumSlateBlue|MediumSpringGreen|MediumTurquoise|MediumVioletRed|MidnightBlue|MintCream|MistyRose|Moccasin|NavajoWhite|Navy|OldLace|Olive|OliveDrab|Orange|OrangeRed|Orchid|PaleGoldenrod|PaleGreen|PaleTurquoise|PaleVioletRed|PapayaWhip|PeachPuff|Peru|Pink|Plum|PowderBlue|Purple|Red|RosyBrown|RoyalBlue|SaddleBrown|Salmon|SandyBrown|SeaGreen|Seashell|Sienna|Silver|SkyBlue|SlateBlue|SlateGray|Snow|SpringGreen|SteelBlue|Tan|Teal|Thistle|Tomato|Turquoise|Violet|Wheat|White|WhiteSmoke|Yellow|YellowGreen))$/i;

    var splited = strInput.split(";");
    if (splited) {
      for (var i = 0  ; i < splited.length ; i++){
        if (splited[i].match(reSemicolon)){
          return {desc: "Missing Semicolon", cause: splited[i]};
        }
        var singlerulesplited = splited[i].split(":");
        if (singlerulesplited.length==2){
          var thirdsplit = singlerulesplited[1].split(" ");
            for (var j = 0 ; j < thirdsplit.length ; j++){
              if (thirdsplit[j]!=""){
                if (thirdsplit[j].match(re1)){
                  width = thirdsplit[j].replace(re1, function($1,$2,$3,$4){return $2;});
                  width += "px";
                }
                else if (thirdsplit[j].match(re2)){
                  style =  thirdsplit[j] ;
                }
                else if (thirdsplit[j].match(re3)){
                  color = thirdsplit[j] ;
                }
                else{
                  return {desc: "Mismatch Width Color Style", cause: thirdsplit[i]};
                }
                if (singlerulesplited[0].match(/^\s*border\s*$/)){
                  top = [width,style,color];
                  right = [width,style,color];
                  bottom= [width,style,color];
                  left = [width,style,color];
                }
                else if (singlerulesplited[0].match(/^\s*border-top\s*$/)){
                  top[0] = width;
                  top[1] = style;
                  top[2]= color;
                }
                else if (singlerulesplited[0].match(/^\s*border-bottom\s*$/)){
                  bottom[0] = width;
                  bottom[1] = style;
                  bottom[2]= color;
                }
                else if (singlerulesplited[0].match(/^\s*border-right\s*$/)){
                  right[0] = width;
                  right[1] = style;
                  right[2] = color;
                }
                else if (singlerulesplited[0].match(/^\s*border-left\s*$/)){
                  left[0] = width;
                  left[1] = style;
                  left[2] = color;
                }
                else if (singlerulesplited[0].match(/^\s*border-width\s*$/)){
                  top[0] = width;
                  right[0] = width;
                  bottom[0]= width;
                  left[0] = width;
                }
                else if (singlerulesplited[0].match(/^\s*border-top-width\s*$/)){
                  top[0] = width;
                }
                else if (singlerulesplited[0].match(/^\s*border-bottom-width\s*$/)){
                  bottom[0]= width;
                }
                else if (singlerulesplited[0].match(/^\s*border-right-width\s*$/)){
                  right[0] = width;
                }
                else if (singlerulesplited[0].match(/^\s*border-left-width\s*$/)){
                  left[0]= width;
                }
                else if (singlerulesplited[0].match(/^\s*border-style\s*$/)){
                  top[1] = style;
                  right[1] = style;
                  bottom[1]= style;
                  left[1] = style;
                }
                else if (singlerulesplited[0].match(/^\s*border-top-style\s*$/)){
                  top[1] = style;
                }
                else if (singlerulesplited[0].match(/^\s*border-bottom-style\s*$/)){
                  bottom[1]= style;
                }
                else if (singlerulesplited[0].match(/^\s*border-right-style\s*$/)){
                  right[1] = style;
                }
                else if (singlerulesplited[0].match(/^\s*border-left-style\s*$/)){
                  left[1]= style;
                }
                else if (singlerulesplited[0].match(/^\s*border-color\s*$/)){
                  top[2] = color;
                  right[2] = color;
                  bottom[2]= color;
                  left[2] = color;
                }
                else if (singlerulesplited[0].match(/^\s*border-top-color\s*$/)){
                  top[2] = color;
                }
                else if (singlerulesplited[0].match(/^\s*border-bottom-color\s*$/)){
                  bottom[2]= color;
                }
                else if (singlerulesplited[0].match(/^\s*border-right-color\s*$/)){
                  right[2] = color;
                }
                else if (singlerulesplited[0].match(/^\s*border-left-color\s*$/)){
                  left[2]= color;
                }
                else{
                  return {desc: "Mismatch Name", cause: singlerulesplited[i]};
              }
            }
          }
        }
        else{
          // if it is an empty string ignore the error handlinig
          if (splited[i].search(/[^\s*]/i)>=0){
            return {desc: "Missing Colon", cause: splited[i]};
          }
        }
      }//End for
      output = top[0]+" "+top[1]+" "+top[2]+";"+right[0]+" "+right[1]+" "+right[2]+";"+bottom[0]+" "+bottom[1]+" "+bottom[2]+";"+left[0]+" "+left[1]+" "+left[2];
    }
    return output;
  };
