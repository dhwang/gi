 ...
 * <p/>
 * <b>Determining the Class of an Object:</b>
 * <p/>
...
window._jsxtmp = function(Object, Object_prototype) {
  ...
  Object_prototype.jsxsuper = function(arg) {
    ...
    if (objMethod == null || !(objMethod instanceof jsx3.lang.Method))
      throw new jsx3.Exception(jsx3._msg("obj.super_funct", fctCaller));
    if (objMethod.isStatic())
      throw new jsx3.Exception(jsx3._msg("obj.super_static", objMethod));
    
    var objClass = objMethod.getDeclaringClass();
    var objSuperMethod = objClass._getSuperMethodFor(objMethod);
    
    if (objSuperMethod == null)
      throw new jsx3.Exception(jsx3._msg("obj.super_none", objMethod));
  ...
  Object_prototype.jsxsupermix = function(arg) {
    ...
    if (objMethod == null || !(objMethod instanceof jsx3.lang.Method))
      throw new jsx3.Exception(jsx3._msg("obj.supmx_funct", fctCaller));
    if (objMethod.isStatic())
      throw new jsx3.Exception(jsx3._msg("obj.supmx_static", objMethod));
    
    var objClass = objMethod.getDeclaringClass();
    var objSuperMethod = objClass._getSuperMixinMethodFor(objMethod);
    
    if (objSuperMethod == null)
      throw new jsx3.Exception(jsx3._msg("obj.supmx_none", objMethod));
