...
/* @JSC */ if (jsx3.CLASS_LOADER.IE) {
    ...
    if (objXML && strCT && strCT.match(/xml/)) {
      if (objXML.documentElement)
        ...
        Request._log(2, jsx3._msg("req.no_doc", this._url));
    } else {
...
/* @JSC */ if (! jsx3.CLASS_LOADER.IE) {
      try {
        ...
        Request._log(2, jsx3._msg("req.netsc", jsx3.NativeError.wrap(e)));
      }
/* @JSC */ }
  ...
  Request_prototype.send = function(strContent, intTimeout) {
    ...
    if (this._async) {
      if (bError || this._request.readyState == 4) {
        ...
        jsx3.sleep(function() {this.publish({subject:Request.EVENT_ON_RESPONSE});}, null, this);
      } else {
        var me = this;
