...
// @jsxobf-clobber-shared  _jsxevents _jsxdynamic _jsxloading
/**
...
//    objChild.recalc();
  ...
  Model_prototype.onChangeServer = function(objNewServer, objOldServer) {
    this.jsxmix(objNewServer, objOldServer);
  };
  ...
  Model_prototype._doLoad = function(objXML, strSourceURL, strNS, objServer, objCache, objResolver, myResolver) {
    ...
    if (! objXML._jsxloading) {
      ...
      if (loadType == Model.LT_SLEEP_DESER || loadType == Model.LT_SLEEP_PD || loadType == Model.LT_SHOW_DESER) {
        ...
        var objInstance = new Model.Loading(objXML, loadType, [strSourceURL, strNS, objServer, objCache, objResolver, myResolver]);
...
/* @JSC :: end */
  ...
  Model_prototype.onBeforeAssemble = function(objParent, objServer) {
    this.jsxmix(objParent, objServer);
  };
