...
jsx3.ide.setResourceProps = function(strId, strNewId, strSrc, strType, intLoad) {
  ...
  if (newInclude != null) {
    jsx3.ERROR.doLog("IDRS01", "can't change resource id to in-use id: " + strNewId, null, false);
    return;
  }

  if (oldInclude != null) {
    if (strSrc != null && oldInclude.src != strSrc && jsx3.ide.getResourceBySrc(strSrc) != null) {
      jsx3.ERROR.doLog("IDRS03", "can't change resource src to in-use src: " + strSrc, null, false);
      return;
    }
    ...
    jsx3.ERROR.doLog("IDRS02", "can't find resource of id: " + strId, null, false);
  }
};

jsx3.ide.addResourceToProject = function(objFile, strType, bAutoLoad) {
  var objSettings = jsx3.ide.getProjectSettings(true);
  jsx3.app.Settings.LOG = jsx3.util.Logger.getLogger("jsx3.app.Settings");
  var path = jsx3.net.URI.decode(jsx3.ide.SERVER.getBaseDirectory().relativePathTo(objFile));
  var insert = objSettings.getMapInArrayByField('includes', "src", path) == null;
  jsx3.app.Settings.LOG = null;
...
jsx3.ide.getResourceById = function(strResourceId) {
  var objSettings = jsx3.ide.getProjectSettings();
  return objSettings.getMapInArrayByField("includes", "id", strResourceId);
};
