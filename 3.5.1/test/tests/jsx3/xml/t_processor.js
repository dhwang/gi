...
gi.test.jsunit.defineTests("jsx3.xml.Processor", function(t, jsunit) {
  ...
  /* Fails on Safari  http://bugs.webkit.org/show_bug.cgi?id=10313 */
  t.testImport = function() {
    var xml = (new jsx3.xml.Document()).loadXML(src1);
    var xsl = (new jsx3.xml.Document()).load(t.resolveURI("data/test1.xsl"));
    var p = new jsx3.xml.Processor(xml, xsl, {p1:"v1", p2:"v2"});
    var d = p.transform();
    jsunit.assertEquals('<wrap a="v1"><tag>v2</tag></wrap>', d);
  };
  t.testImport._unless = "SAF";
