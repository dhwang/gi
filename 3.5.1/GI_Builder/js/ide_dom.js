...
jsx3.ide.getDomRecordValues = function(objJSX) {
  var Model = jsx3.app.Model;
  var c = "", img = "images/icon_89.gif", text = objJSX.getName();
...
/** BUILD TREE ****************************************************/
jsx3.ide.buildTree = function(objTree, objJSX, strParentId) {
  ...
  if(strParentId == null) {
    ...
    var classImageText = jsx3.ide.getDomRecordValues(objJSX);
  ...
  if (intPersist == null || intPersist == jsx3.app.Model.PERSISTNONE || intPersist == jsx3.app.Model.PERSISTEMBED) {
    ...
    for (var i = 0; i < objKids.length; i++)
      jsx3.ide.buildTree(objTree, objKids[i], o.jsxid);
  }
};
