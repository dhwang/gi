...
<xsl:stylesheet version="2.0"
  ...
  <xsl:output
    ...
    <html>
      <head>
        <title><xsl:value-of disable-output-escaping="yes">@gi.apidocs.title.esc@</xsl:value-of> - API Documentation</title>
      ...
      <body>
        ...
        <h1><xsl:value-of disable-output-escaping="yes">@gi.apidocs.title.esc@</xsl:value-of>
