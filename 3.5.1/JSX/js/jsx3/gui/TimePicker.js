          ...
          _set: function(picker, value) {
            if (value == null || value === "") {
              ...
              if (ampmField != null && ampmField.value != null && ampmField.value.toLowerCase() == ampm[1].toLowerCase())
                picker.jsxhours = value == 12 ? value : value + 12;
              else
                picker.jsxhours = value == 12 ? 0 : value;
            }
          },
          ...
          _set: function(picker, value) {
            ...
            if (! isNaN(hourValue)) {
              if (value != null && value.toLowerCase() == ampm[1].toLowerCase())
                picker.jsxhours = hourValue == 12 ? hourValue : hourValue + 12; // PM
              else
                picker.jsxhours = hourValue == 12 ? 0 : hourValue; // AM
            }
          },
