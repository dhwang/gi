...
// @jsxobf-clobber-shared  _applyMixins
...
window._jsxtmp = function(Object, Object_prototype) {
  ...
  /**
   * Invokes any method mixins registered with the method that calls <code>jsxmix()</code>. A method mixin is
   * only invoked if this object is an instance of the class registered with the mixin.
   * <p/>
   * <code>jsxmix()</code> is useful when a method of a base or abstract class is designed to be overridden and
   ...
   * @see jsx3.lang.Class#addMethodMixin()
   * @since 3.5
   */
  Object_prototype.jsxmix = function(arg) {
    ...
    if (objMethod == null || !(objMethod instanceof jsx3.lang.Method))
      throw new Exception(jsx3._msg("obj.mix_funct", fctCaller));
    if (objMethod.isStatic())
      throw new Exception(jsx3._msg("obj.mix_static", objMethod));

    fctCaller.jsxmethod._applyMixins(this, arguments);
  };
...
/* @JSC :: begin DEP */
  ...
  // TODO: deprecate this, move it to IDE?
  /**
   ...
   * @private
   */
  Object_prototype.debug = function() {
    ...
    var oP = jsx3.getClassPrototype(this.getInstanceOf());
    oP.jsxMethod = jsx3.ide.doDebug;
    return this.jsxMethod(objExpression);
  };
