...
jsx3.Class.defineClass("jsx3.gui.TimePicker", jsx3.gui.Block, [jsx3.gui.Form], function(TimePicker, TimePicker_prototype) {
   ...
   * @param vntValue {String|Date} the date whose time of day information to use for setting the value of this time picker.
   *   If the data type is <code>String</code>, the format should match that returned by the corresponding method, <code>getValue</code>
   */
  TimePicker_prototype.setValue = function(vntValue) {
    if(!jsx3.util.strEmpty(vntValue))
      this.setDate(vntValue instanceof Date ? vntValue : new Date("1/1/1970 " + vntValue));
  };
