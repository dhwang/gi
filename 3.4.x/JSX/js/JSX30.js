...
//        jsx3._logIt("loadApp " + strAppPath);
        ...
        var app = {_path:strAppPath, _gui:objGUI, _queued:false, _loaded:false, _env: objEnv, _serial:ClassLoader._SERIAL++};
...
//        jsx3._logIt("_incrementDone:" + this._done + "/" + this._total);
        ...
        if (this._classloader.IE && ((this._done % 20) == 0 || this._total < 5 || this._done == this._total)) {
