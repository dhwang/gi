...
jsx3.Class.defineClass("jsx3.gui.TabbedPane", jsx3.gui.Block, null, function(TabbedPane, TabbedPane_prototype) {
   ...
   * @package
   */
  TabbedPane_prototype.paintChild = function(objJSX, bGroup) {
    ...
    if (objGUI != null) {
      ...
      contentPane.setDisplay(bFirst ? Block.DISPLAYBLOCK : Block.DISPLAYNONE);
   ...
   * @package
   */
  TabbedPane_prototype.getClientDimensions = function() {
    ...
    if (this.getParent()) {
      ...
      dims = {parentwidth:myWidth,parentheight:intTabSize};
    }
    ...
    if(objGUI) {
      ...
      for (var i = 0; i < oKids.length; i++) {
        ...
        if (objCChild != null) {
          ...
          objCChild.setDisplay(bActive ? Block.DISPLAYBLOCK : Block.DISPLAYNONE, true);
  ...
  TabbedPane_prototype.createBoxProfile = function(objImplicit) {
    ...
    if(objImplicit.boxtype == null) objImplicit.boxtype = "box";
  ...
  TabbedPane_prototype.paint = function() {
    ...
    for (var i = 0; i < children.length; i++) {
      ...
      if (objKid != null) {
        objKid.setDisplay((this.getSelectedIndex() == i) ? Block.DISPLAYBLOCK : Block.DISPLAYNONE);
    ...
    if (objTab) {
      ...
      if (bShowOnly || curIndex != intIndex) {
        ...
        for (var i = 0; i < maxLen; i++) {
          ...
          if (i == intIndex) {
            if (contentPane)
              contentPane.setDisplay(Block.DISPLAYBLOCK, true);
            if (bShowTabs)
              child.setBackgroundColor(child.paintActiveColor(), true);
            ...
            if (contentPane)
              contentPane.setDisplay(Block.DISPLAYNONE, true);
            if (bShowTabs)
              child.setBackgroundColor(child.paintInactiveColor(), true);
          }
        }
      }
