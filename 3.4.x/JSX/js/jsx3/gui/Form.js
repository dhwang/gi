...
/* @JSC :: end */
  ...
  /** @package */
  Form_prototype._emPaintStandardCdfTemplate = function(strEnabled, strDisabled) {
  ...
  Form_prototype.emUpdateDisplay = function(objTdDim, objPaneDim) {
    ...
    var height = isNaN(h) ? objTdDim.H : Math.min(parseInt(h), objTdDim.H);
  ...
  Form_prototype.emRestoreDisplay = function() {
    this.setDisplay(jsx3.gui.Block.DISPLAYNONE, true);
    var es = this.emGetSession();
    this.setWidth(es.width, false);
    this.setHeight(es.height, false);
  };
