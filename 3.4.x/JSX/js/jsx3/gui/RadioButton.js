...
/* @JSC :: end */
  ...
  RadioButton_prototype.paint = function() {
    ...
    b1.setAttributes(' id="' + this.getId() + '"' + this.paintLabel() + ' class="' + this.paintClassName() + '" unselectable="on" ' + this.paintTip() + this.paintEnabled() + strEvents + strProps);
    b1.setStyles(((b1.getPaintedWidth())?"overflow-x:hidden;":"")+ this.paintCursor() + this.paintFontName() + this.paintFontSize() + this.paintFontWeight() + this.paintColor() + this.paintBackgroundColor() + this.paintVisibility() + this.paintDisplay() + this.paintZIndex() + this.paintCSSOverride());
    ...
    b1a.setAttributes(' type="radio" name="' + this.getGroupName() + '" value="' + this.getValue() + '" ' + this.paintEnabled() + this.paintSelected() + this.paintIndex());

    //get the label
    var b1c = b1.getChildProfile(1);
    b1c.setAttributes(' unselectable="on" ');
   ...
   * @private
   */
  RadioButton_prototype.paintCursor = function() {
    return (this.getCursor() == null) ? 'cursor:hand;' : 'cursor:' + this.getCursor() + ';';
  };
...
/* @JSC :: end */
  ...
  RadioButton_prototype.emPaintTemplate = function() {
    ...
    var html = this._emPaintStandardCdfTemplate(enabled, disabled);
