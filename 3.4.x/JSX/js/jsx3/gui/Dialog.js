...
/* @JSC :: end */
  ...
  /**
   * jsx3.gui.Dialog.TASKBARICON {String} JSX/images/dialog/window.gif
   * @private
   * @jsxobf-clobber
   */
  Dialog.TASKBARICON = jsx3.resolveURI("jsx:///images/dialog/window.gif");

  /**
   * jsx3.gui.Dialog.CLOSEICON {String} JSX/images/dialog/close.gif
   * @private
   * @jsxobf-clobber
   */
  Dialog.CLOSEICON = jsx3.resolveURI("jsx:///images/dialog/close.gif");

  /**
   * jsx3.gui.Dialog.MINIMIZEICON {String} JSX/images/dialog/min.gif
   * @private
   * @jsxobf-clobber
   */
  Dialog.MINIMIZEICON = jsx3.resolveURI("jsx:///images/dialog/min.gif");
  ...
  /**
   * jsx3.gui.Dialog.MAXICON {String} JSX/images/dialog/max.gif
   * QUESTION: I think that these should either all be resolved URIs or none should be
   * @private
   * @jsxobf-clobber
   */
  Dialog.MAXICON = "JSX/images/dialog/max.gif";

  /**
   * jsx3.gui.Dialog.RESTOREICON {String} JSX/images/dialog/restore.gif
   * @private
   * @jsxobf-clobber
   */
  Dialog.RESTOREICON = "JSX/images/dialog/restore.gif";
  ...
  Dialog_prototype.init = function(strName,vntWidth,vntHeight,strTitle) {
    ...
    jButton.setDynamicProperty("jsxtip","@Min Tip");
    ...
    jButton.setDynamicProperty("jsxtip","@Close Tip");
    jToolbar.setChild(jButton,jsx3.app.Model.PERSISTEMBED,null,jsx3.app.Model.FRAGMENTNS);
  };
  ...
  Dialog_prototype.doToggleState = function(STATE) {
    ...
    if ((myButton = this.getTaskButton()) != null) {
      ...
      if (state == Dialog.MAXIMIZED) {
        ...
        var xPro = this.getBoxProfile(true);
        objGUI.style.height = xPro.getPaintedHeight() + "px";
        objGUI.childNodes[2].style.height = xPro.getPaintedHeight() + "px";
        ...
        var xPro = this.getBoxProfile(true);
        var diffY = xPro.getOffsetHeight() - xPro.getPaintedHeight();

        //resize outer box and bounding box
        objGUI.style.height = (32 - diffY) + "px";
        objGUI.childNodes[2].style.height = (32 - diffY) + "px";
  ...
  Dialog_prototype.setDisplay = function(DISPLAY, bRepaint) {
    ...
    if(bRepaint) this.updateGUI("display",DISPLAY);
    return this;
  };
   ...
   * @package
   */
  Dialog_prototype.updateGUI = function(strCSSName,strCSSValue) {
    var objGUI = this._getRenderedDialog();
    if(objGUI != null) {
      try {
  ...
  Dialog_prototype.doMaximize = function(objTBB) {
    ...
    if (this._jsxmaxstate != null) {
      ...
      this.jsxwidth = wh[0];
      this.jsxheight = wh[1];
      this.jsxleft = this._jsxmaxstate.jsxleft;
      this.jsxtop = this._jsxmaxstate.jsxtop;
      ...
      if (objTBB) objTBB.setDynamicProperty("jsxtip","@Max Tip").setImage(Dialog.MAXICON).repaint();
    } else {
      //update the model
      this._jsxmaxstate = {};
      ...
      this.jsxwidth = wh[0];
      this.jsxheight = wh[1];
      this.jsxleft = Math.min(parseInt(objGUI.style.left), objP.W - this.jsxwidth - Dialog.CONSTRAIN_PADDING[1]);
      this.jsxtop = Math.min(parseInt(objGUI.style.top), objP.H - this.jsxheight - Dialog.CONSTRAIN_PADDING[2]);
      ...
      //update captionbar icon
      if (objTBB) objTBB.setDynamicProperty("jsxtip","@Restore Tip").setImage(Dialog.RESTOREICON).repaint();
    }
  };
...
/* NEW BOX MODEL ABSTRACTION FOR DIALOG **********************************************/
  ...
  Dialog_prototype.createBoxProfile = function(objImplicit) {
    ...
    if(objImplicit.height == null) objImplicit.height = (bMinimized) ? 30 : this.getHeight();
    objImplicit.tagname = "div";
    objImplicit.boxtype = "box";
    objImplicit.padding = "2 2 2 2";
    objImplicit.border = "1px pseudo";
    ...
    o.width = "100%";
    o.height = (this.getHeight() - (myCaptionBar != null ? (myCaptionBar.getHeight() + 8) : 6));
    o.top = myCaptionBar != null ? (myCaptionBar.getHeight() + 4) : 2;
    o.left = 2;
    o.tagname = "div";
    o.boxtype = "box";
    o.border = "1px pseudo";
    ...
    o.height = (bMinimized) ? 30 : this.getHeight();
    o.tagname = "div";
    o.boxtype = "box";
    o.padding = "0";
    o.border = "1px pseudo";
  ...
  Dialog_prototype.updateBoxProfile = function(objImplicit, objGUI, objQueue) {
    ...
    if (objGUI != null) {
      ...
      var myHeight = (this.getHeight() - (myCaptionBar != null ? (myCaptionBar.getHeight() + 8) : 6));
  ...
  Dialog_prototype.paint = function() {
    ...
    if (bModal) {
      ...
      var objModalWrapper = ['<div id="' + strId + '" ' + this.paintIndex() + this.renderHandler(Event.KEYDOWN, "_doModalKeyDown", 0) +
      ...
      b1.setAttributes('label="' + this.getName() + '"' + strImplementedEvents + this.paintIndex() + ' class="' + this.paintClassName() + '" ' + strProps);
    ...
    if (this.getServer() != null && (myTaskBar = this.getServer().getTaskBar()) != null && this.getModal() != Dialog.MODAL) {
      ...
      if (myCaptionBar != null) {
        if (myTaskButton == null) {
          ...
          objChild.setImage(Dialog.TASKBARICON);
          ...
          myTaskButton.setText(jsx3.util.strTruncate(myCaptionBar.getText(), 20)).repaint();
        }
