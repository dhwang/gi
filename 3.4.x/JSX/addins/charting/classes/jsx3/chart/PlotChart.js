...
jsx3.Class.defineClass("jsx3.chart.PlotChart", jsx3.chart.CartesianChart, null, function(PlotChart, PlotChart_prototype) {
  ...
  PlotChart.ALLOWED_MAGNITUDE_METHODS = {radius: 1, diameter: 1, area: 1};
  ...
  PlotChart_prototype.setMagnitudeMethod = function( magnitudeMethod ) {
    if (PlotChart.ALLOWED_MAGNITUDE_METHODS[magnitudeMethod]) {
   ...
   * @private
   */
  PlotChart_prototype.updateView = function() {
    this.jsxsuper();
    this.drawSeries();
  };
   ...
   * @private
   */
  PlotChart_prototype.drawSeries = function() {
  ...
  PlotChart_prototype.toString = function() {
    return "[PlotChart '" + this.getName() + "']";
  };
