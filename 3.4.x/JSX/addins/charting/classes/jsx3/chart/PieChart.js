...
jsx3.Class.defineClass("jsx3.chart.PieChart", jsx3.chart.RadialChart, null, function(PieChart, PieChart_prototype) {
  ...
  PieChart_prototype.getColorFunction = function() {
    return this.getFunctionField("colorFunction");
  };

  /**
   * Sets the colorFunction field.
   * @param colorFunction {String} the new value for colorFunction, should eval to a function with the signature function(record, index) : jsx3.vector.Fill
   */
  PieChart_prototype.setColorFunction = function( colorFunction ) {
    this.setReferenceField("colorFunction", colorFunction);
  };
   ...
   * @private
   */
  PieChart_prototype.updateView = function() {
    this.jsxsuper();
  ...
  PieChart_prototype.toString = function() {
    return "[PieChart '" + this.getName() + "']";
  };
