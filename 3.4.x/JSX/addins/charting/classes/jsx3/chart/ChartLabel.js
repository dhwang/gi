...
jsx3.Class.defineClass("jsx3.chart.ChartLabel", jsx3.chart.ChartComponent, null, function(ChartLabel, ChartLabel_prototype) {
  ...
  ChartLabel_prototype.getPreferredWidth = function() {
    if (this.preferredWidth != null) {
      ...
      return this.getNormalDimension();
    } else {
   ...
   * @jsxobf-clobber
   */
  ChartLabel_prototype.getNormalDimension = function() {
    var padding = this.getPaddingDimensions();
  ...
  /**
   * control repainting triggered by a property edit
   * @package
   */
  ChartLabel_prototype.onResize = function() {
    var parent = this.getParent();
    if (parent != null) {
      if (jsx3.chart.Axis && parent instanceof jsx3.chart.Axis)
  ...
  ChartLabel_prototype.onSetParent = function(objParent) {
    return objParent instanceof jsx3.chart.ChartComponent;
  };

  ChartLabel_prototype.toString = function() {
    return "[jsx3.chart.ChartLabel '" + this.getName() + "']";
  };
