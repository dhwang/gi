...
jsx3.Class.defineClass("jsx3.chart.Series", jsx3.chart.ChartComponent, null, function(Series, Series_prototype) {
   ...
   * @param tooltipFunction {String} evals to a function with the signature function(series,record) : string
   */
  Series_prototype.setTooltipFunction = function( tooltipFunction ) {
    this.setReferenceField("tooltipFunction", tooltipFunction);
  };
  ...
  Series_prototype.getTooltipFunction = function() {
    return this.getFunctionField("tooltipFunction");
  };
   ...
   * @param colorFunction {String} the new value for colorFunction
   * @since 3.1
   */
  ...
  Series_prototype.toString = function() {
