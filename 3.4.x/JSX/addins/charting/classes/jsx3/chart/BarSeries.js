...
jsx3.Class.defineClass("jsx3.chart.BCSeries", jsx3.chart.Series, null, function(BCSeries, BCSeries_prototype) {
   ...
   */
  BCSeries_prototype.getParallelValue = jsx3.Method.newAbstract();
   ...
   * @jsxobf-clobber-shared
   */
  BCSeries_prototype.getNormalValue = jsx3.Method.newAbstract();
   ...
   * @jsxobf-clobber-shared
   */
  BCSeries_prototype.getNormalWidth = jsx3.Method.newAbstract();
   ...
   * @private
   */
  BCSeries_prototype.getShownAreas = function() {
  ...
  BCSeries_prototype.updateView = function() {
    ...
    var shownAreas = this.getShownAreas();
  ...
  BCSeries_prototype.drawArea = function(record, index, x1, y1, x2, y2, internal) {
    if (! internal)
      this.getShownAreas().push([record,index,x1,y1,x2,y2]);
    ...
    var fill = colorFunct != null ? colorFunct.call(null, record, index) : this.fetchTransient("trans_shownFill");
    rectangle.setFill(fill);
    rectangle.setStroke(this.fetchTransient("trans_shownStroke"));

    var funct = this.getTooltipFunction();
    if (funct != null)
      rectangle.setToolTip(funct.call(null, this, record));
...
jsx3.Class.defineClass("jsx3.chart.BarSeries", jsx3.chart.BCSeries, null, function(BarSeries, BarSeries_prototype) {
  ...
  BarSeries_prototype.getParallelValue = function( record ) {
    return this.getXValue(record);
  };

  BarSeries_prototype.getNormalValue = function( record ) {
    return this.getYValue(record);
  };

  BarSeries_prototype.getNormalWidth = function() {
  ...
  BarSeries_prototype.toString = function() {
    return "[BarSeries '" + this.getName() + "']";
  };
...
jsx3.Class.defineClass("jsx3.chart.ColumnSeries", jsx3.chart.BCSeries, null, function(ColumnSeries, ColumnSeries_prototype) {
  ...
  ColumnSeries_prototype.getParallelValue = function( record ) {
    return this.getYValue(record);
  };

  ColumnSeries_prototype.getNormalValue = function( record ) {
    return this.getXValue(record);
  };

  ColumnSeries_prototype.getNormalWidth = function() {
