...
jsx3.Class.defineClass("jsx3.chart.LogarithmicAxis", jsx3.chart.Axis, null, function(LogarithmicAxis, LogarithmicAxis_prototype) {
   ...
   * @final @jsxobf-final
   */
  LogarithmicAxis.PADDING_FACTOR = 1.0;

  // Use these values if there is no data range.
  /** @private @jsxobf-clobber @jsxobf-final */
  LogarithmicAxis.DEFAULT_MIN_EXPONENT = 0;
  /** @private @jsxobf-clobber @jsxobf-final */
  LogarithmicAxis.DEFAULT_MAX_EXPONENT = 2;  
  ...
  LogarithmicAxis_prototype.init = function(name, horizontal, primary) {
    ...
    this.storeTransient("trans_shownMinExp", LogarithmicAxis.DEFAULT_MIN_EXPONENT);
    this.storeTransient("trans_shownMaxExp", LogarithmicAxis.DEFAULT_MAX_EXPONENT);
  };
  ...
  LogarithmicAxis_prototype.prePaintUpdate = function() {
    ...
    if (! success) {
      this.storeTransient("trans_shownMinExp", 
          this.minExponent != null ? this.minExponent : LogarithmicAxis.DEFAULT_MIN_EXPONENT);
      this.storeTransient("trans_shownMaxExp", 
          this.maxExponent != null ? this.maxExponent : LogarithmicAxis.DEFAULT_MAX_EXPONENT);
    }
  };
   ...
   * @jsxobf-clobber 
   */
  LogarithmicAxis_prototype.adjustForRange = function() {
    ...
    rangeMin *= LogarithmicAxis.PADDING_FACTOR;
    rangeMax *= LogarithmicAxis.PADDING_FACTOR;
   ...
   * @package
   */
  LogarithmicAxis_prototype.getMinorTicks = function(majorTicks, index) {
    var ticks = [];
    if (index == 0) {
  ...
  LogarithmicAxis_prototype.toString = function() {
    return "[LogarithmicAxis '" + this.getName() + "']";
  };
