  ...
  if (! success) {
    ...
    if (dialog.getHelpBlock() == null) {
      if (w != null && w.getHelpBlock() != null) {
        ...
        jsx3.sleep(function(){
          dialog.getHelpBlockParent().load('components/apihelp/apihelp.xml');});
      }
    }
...
//  jsx3.ide.LOG.info("onContextHelp " + objEvent.helpid);
  ...
  if (! xml.hasError()) {
    ...
    jsx3.IDE.alert("Documentation Not Installed",
        ...
        "Please <a href='http://gi.tibco.com/links/devnet/' target='_blank'>download the General Interface&#8482; documentation</a> and make sure that it is installed in the doc/ directory.");
  }
};
