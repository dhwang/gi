...
/* @JSC */ }
  ...
  Document_prototype._initFromReq2 = function(objReq) {
    //LUKE (3.6.2): the following is an attempt to determine if an XML document should even be loaded via getResponseXML
    ...
    //can be used to better limit if the XML was actually located.  Since NOT returning a document is a restrictive
