...
/* @JSC */ }
  ...
  Document_prototype._initFromReq = function(objReq) {
    ...
    if (status == jsx3.net.Request.STATUS_OK) {
      var url = this._url;
      this._initFromReq2(objReq.getNative());
      this._url = url;
    } else {
  ...
  Document_prototype._initFromReq2 = function(objReq) {
    // using responseXML leads to security errors too often
    this.loadXML(objReq.responseText);
  };
