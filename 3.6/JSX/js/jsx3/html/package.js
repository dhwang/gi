...
/* @JSC */ } else if (jsx3.CLASS_LOADER.FX) {
  ...
  html.getRelativePosition = function(objRoot, objGUI) {
    ...
    var box = doc.getBoxObjectFor(objGUI);
    var vpBox = doc.getBoxObjectFor(objRoot);
    var myLeft = box.screenX-vpBox.screenX + objRoot.scrollLeft;
    var myTop = box.screenY-vpBox.screenY + objRoot.scrollTop;
    return {L:myLeft,T:myTop,W:objGUI.offsetWidth,H:objGUI.offsetHeight}
  };
