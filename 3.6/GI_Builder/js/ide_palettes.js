    ...
    var objContent = jsx3.IDE.getJSXByName(strName);
      ...
      if (! isDialog) {
        ...
        var stackGroup = jsx3.IDE.getJSXByName('jsx_ide_quadrant_' + quadrant);
          ...
          var stack = stackGroup.loadAndCache('components/palettes/stack.xml', false);//, !bStartUp);
          if (! bStartUp)
            stackGroup.setSelectedIndex(stack.getChildIndex());
          var content = stack.load(strUrl);
          ...
          // make contextual help work in entire stack
          stack.setHelpId(content.getHelpId());
				
          stackGroup.paintChild(stack);
        ...
        // make contextual help work in entire stack
        dialog.setHelpId(content.getHelpId());
    ...
    jsx3.sleep(function(){
		...
		if (stackGroup != null) {
          ...
          jsx3.sleep(function(){
						...
						stackGroup.adoptChild(objContainer, false);
            stackGroup.setSelectedIndex(objContainer.getChildIndex());
            stackGroup.paintChild(objContainer);
            objContainer.focus();
...
jsx3.ide.swapStackToDialog = function(objStack, objDim) {
  ...
  content.setDisplay(jsx3.gui.Block.DISPLAYBLOCK,false);
...
jsx3.ide.swapDialogToStack = function(objDialog, objStackGroup) {
  ...
  jsx3.sleep(function() {
    ...
    objStackGroup.setSelectedIndex(stack.getChildIndex());
...
jsx3.ide.toggleStageOnly = function(bShowPalettes) {
	...
	if (bShowPalettes) {
		...
		jsx3.ide.rebalancePaletteDocks();
	} else {
