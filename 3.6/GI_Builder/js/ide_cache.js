...
/* @jsxobf-clobber */
jsx3.ide.getServerForCacheId = function(strId) {
...
jsx3.ide.doOpenCacheDocument = function(objTree, strRecordId) {
  return jsx3.ide.doOpenCacheEditor(jsx3.ide.getServerForCacheId(strRecordId), strRecordId);
};
...
jsx3.ide.updateCacheSleep = function() {
  jsx3.sleep(jsx3.ide.updateCache, "jsx3.ide.updateCache");
};
