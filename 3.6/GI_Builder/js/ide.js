...
jsx3.ide.onStartUp2 = function() {
  ...
  if (myProject) {
    ...
    //pause the queue and instance the project server
    queue.pause();
...
jsx3.ide.addinStartup = function() {
  ...
  jsx3.sleep(function() {
    jsx3.ide.loadBuilderAndProjectAddins(jsx3.ide.SERVER, function() {
      jsx3.sleep(function() {
...
jsx3.ide.getIDESettings = function() {
  if (jsx3.ide._SETTINGS == null) {
    ...
    if (homeDir) {
      var settingsURI = homeDir.toURI().resolve(strPath);
      settingsFile = new jsx3.io.File(settingsURI);
        
      // make sure that builder prefs file exists
      if (! settingsFile.exists()) {
        var templateDir = jsx3.ide.getBuilderRelativeFile(jsx3.ide.HOME_TEMPLATE_DIR);
        var templateFile = new jsx3.io.File(templateDir, strPath);
