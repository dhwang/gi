...
describe("jsx3.xml.CDF", function() {
  ...
  var newCDF = function(strURL) {
    ...
    var r = cdf.getRecord("5");
     ...
     //expect(cdf.getRecord("-1")).toBeUndefined();
    ...
    var cdf = newCDF("data/cdf1.xml");
      //expect(cdf.getRecord("2").prop1).toBeNull();
    ...
    cdf.insertRecordProperty("2a", "prop1a", "val1a");
      expect(cdf.getRecordNode("2a")).toBeNull();
      //expect(cdf.getRecordNode("2a")).toBeUndefined();
 ...
 it("testDeleteRecordProperty", function() {
    var cdf = newCDF("data/cdf1.xml");
      ...
      //expect(cdf.getRecord("2").jsxtext).toBeNull();
 ...
 it("testGetKey", function() {
  ...
  it("testNewDocument", function() {
    ...
    var e = cdf2.adoptRecord(cdf1, "4");
      ...
      //  expect(cdf1.getRecord("4")).toBeUndefined();
