...
describe("jsx3.gui.DatePicker", function(){
  ...
  it("should able to overridden on an instance of a DatePicker to control which dates are selectable in the calendar popup", function() {
    // expect(datePicker.allowDate(2014,4,1)).toBe(false);
    // var today = new Date('Mar 1, 1999');
    // datePicker.setDate(today); 
    // expect(datePicker.getDate()).toEqual(today); 
    // datePicker.setValue("Apr 1, 2014");
    // expect(datePicker.getValue()).toEqual('MMM d, yyyy');
  });
  ...
  it("should able to set and get the jsxfirstweekday field", function() {
  ...
  it("should not take invalide date value", function() {
    ...
    datePicker.repaint();
    expect(datePicker.getValue()).toEqual('Jan 1, 1970')
    datePicker.setValue(datePicker.getDate().valueOf() * -1);
    datePicker.repaint();
    expect(datePicker.getValue()).toEqual('Jan 1, 1970')
  });
