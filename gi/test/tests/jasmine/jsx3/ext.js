...
describe("ext - Javascript extended functions", function(){
  ...
  _jasmine_test.require("jsx3.$Y", "jsx3.jsxpackage", "jsx3.util.jsxpackage", "jsx3.util.EventDispatcher");
	...
	describe("jsx3.$AsyncRV, jsx3.$AsyncCB, jsx3.$Y -", function(){
		...
		it("has method args() that will return the arguments that were passed to the async menthod wrapper", function(){
			var f = jsx3.$Y(function(cb){
				var args = cb.args();
		...
		it("$Y() would wrap an async method.", function(){
			var f = jsx3.$Y(function(cb){
				jsx3.sleep(function(){cb.done(1);});
			});
			var rv =f();
      ...
      waitsFor(function(){
		...
		it("should return the return value from the async method", function(){
			var f1 = jsx3.$Y(function(cb) {
        jsx3.sleep(function() {
          cb.done(1);
        });
      ...
      waitsFor(function(){
		...
		it("should be able to async with param", function(){
			var f1 = jsx3.$Y(function(cb){
				jsx3.sleep(function(){
					cb.done(1);
				});
